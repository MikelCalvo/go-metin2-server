...
func main() {
	...
	opsHandler = ops.RegisterLocalQuestStateTransitionPreviewEndpoint(
		opsHandler,
		func(transition queststate.Transition) (any, error) {
	...
	opsHandler = ops.RegisterLocalSpawnGroupHomewardStepsEndpoint(
		opsHandler,
		func() any { return gameRuntime.SpawnGroupHomewardSteps() },
	)
	opsHandler = ops.RegisterLocalSpawnGroupHomewardStepSnapshotEndpoint(
		opsHandler,
		func(entityID uint64) (any, bool) {
			snapshot, ok := gameRuntime.SpawnGroupHomewardStep(entityID)
			if !ok {
				return nil, false
			}
			return snapshot, true
	...
	opsHandler = ops.RegisterLocalMapSpawnGroupHomewardStepsEndpoint(
		opsHandler,
		func(mapIndex uint32) (any, bool) {
			homewardSteps, ok := gameRuntime.SpawnGroupHomewardStepsForMap(mapIndex)
			if !ok {
				return nil, false
			}
			return homewardSteps, true
		},
	)
	...
	opsHandler = ops.RegisterLocalContentBundleMapWarpRoutesEndpoint(
		opsHandler,
		exportContentBundleSummary,
	)
	opsHandler = ops.RegisterLocalContentBundleMapOpenSafeboxRoutesEndpoint(
		opsHandler,
		exportContentBundleSummary,
	)
	...
	opsHandler = ops.RegisterLocalContentBundleQuestStateEndpoint(
		opsHandler,
		exportContentBundleSummary,
	)
	...
	opsHandler = ops.RegisterLocalContentBundleOpenSafeboxRouteEndpoint(
		opsHandler,
		exportContentBundleSummary,
	)
	...
	opsHandler = ops.RegisterLocalContentBundleInteractableStaticActorImportPreviewEndpoint(
		opsHandler,
		previewContentBundleImport,
	)
	...
	opsHandler = ops.RegisterLocalContentBundleItemTemplateImportPreviewEndpoint(
		opsHandler,
		previewContentBundleImport,
	)
	...
	opsHandler = ops.RegisterLocalContentBundleWarpDestinationImportPreviewEndpoint(
		opsHandler,
		previewContentBundleImport,
	)
	...
	opsHandler = ops.RegisterLocalContentBundleQuestStateImportPreviewEndpoint(
		opsHandler,
		previewContentBundleImport,
	)
