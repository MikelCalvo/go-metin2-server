...
- [ ] Note: `LESS_GOLD` accept-time displayed-gold rejects and mutual-accept persistence-failure silent fail-closed still leave the shell cancellable; do not expect auto-cancel on those paths
