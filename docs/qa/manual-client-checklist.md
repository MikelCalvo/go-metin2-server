...
- that owner-side retaliation point-loss now clamps at `0` HP too, and once the floor is reached the current slice stops further retaliation point-loss without yet claiming broader player-death behavior
