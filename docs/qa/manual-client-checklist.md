...
- [ ] If QA imports authored NPC/content bundles, `POST /local/content-bundle/validate` accepts the exact candidate fixture before import; invalid UTF-8, JSON `null` collection fields, dangling refs, unsupported future interaction kinds such as unfrozen quest/dialog metadata, missing merchant/reward item templates (for example `docs/examples/bootstrap-invalid-reward-drop-without-item-templates-bundle.json`, `docs/examples/bootstrap-invalid-reward-drop-item-missing-from-item-templates-bundle.json`, `docs/examples/bootstrap-invalid-combat-profile-death-reward-item-missing-from-item-templates-bundle.json`, `docs/examples/bootstrap-invalid-combat-profile-death-reward-without-item-templates-bundle.json`, `docs/examples/bootstrap-invalid-merchant-catalog-without-item-templates-bundle.json`, `docs/examples/bootstrap-invalid-merchant-catalog-item-missing-from-item-templates-bundle.json`, `docs/examples/bootstrap-invalid-merchant-catalog-count-above-stack-limit-bundle.json`, `docs/examples/bootstrap-invalid-merchant-catalog-count-above-non-stackable-limit-bundle.json`, `docs/examples/bootstrap-invalid-quest-flag-reward-item-missing-from-item-templates-bundle.json`, `docs/examples/bootstrap-invalid-quest-flag-reward-item-without-item-templates-bundle.json`, `docs/examples/bootstrap-invalid-quest-flag-consume-item-missing-from-item-templates-bundle.json`, `docs/examples/bootstrap-invalid-quest-flag-consume-item-without-item-templates-bundle.json`, `docs/examples/bootstrap-invalid-quest-flag-reward-item-count-above-stack-limit-bundle.json`, `docs/examples/bootstrap-invalid-quest-flag-reward-item-count-above-non-stackable-limit-bundle.json`, `docs/examples/bootstrap-invalid-quest-flag-consume-item-count-above-stack-limit-bundle.json`, or `docs/examples/bootstrap-invalid-quest-flag-consume-item-count-above-non-stackable-limit-bundle.json`, or `docs/examples/bootstrap-invalid-open-cube-foreign-size-bundle.json`, or `docs/examples/bootstrap-invalid-open-cube-foreign-title-bundle.json`, or `docs/examples/bootstrap-invalid-open-safebox-foreign-title-bundle.json`, or `docs/examples/bootstrap-invalid-open-safebox-foreign-catalog-bundle.json`, or `docs/examples/bootstrap-invalid-open-cube-foreign-catalog-bundle.json`, or `docs/examples/bootstrap-invalid-open-safebox-foreign-warp-coords-bundle.json`, or `docs/examples/bootstrap-invalid-open-cube-foreign-warp-coords-bundle.json`, or `docs/examples/bootstrap-invalid-open-safebox-oversize-size-bundle.json`, or `docs/examples/bootstrap-invalid-open-safebox-foreign-reward-gold-bundle.json`, or `docs/examples/bootstrap-invalid-open-cube-foreign-reward-gold-bundle.json`, or `docs/examples/bootstrap-invalid-open-cube-foreign-reward-experience-bundle.json`, or `docs/examples/bootstrap-invalid-open-safebox-foreign-reward-experience-bundle.json`, or `docs/examples/bootstrap-invalid-open-safebox-foreign-consume-gold-bundle.json`, or `docs/examples/bootstrap-invalid-open-cube-foreign-consume-gold-bundle.json`, or `docs/examples/bootstrap-invalid-open-safebox-foreign-consume-experience-bundle.json`, or `docs/examples/bootstrap-invalid-open-cube-foreign-consume-experience-bundle.json`, or `docs/examples/bootstrap-invalid-open-safebox-foreign-reward-items-bundle.json`, or `docs/examples/bootstrap-invalid-open-cube-foreign-reward-items-bundle.json`, or `docs/examples/bootstrap-invalid-open-safebox-foreign-consume-items-bundle.json`, or `docs/examples/bootstrap-invalid-open-cube-foreign-consume-items-bundle.json`, or `docs/examples/bootstrap-invalid-open-safebox-foreign-quest-to-bundle.json`, or `docs/examples/bootstrap-invalid-open-cube-foreign-quest-to-bundle.json`, or `docs/examples/bootstrap-invalid-open-safebox-foreign-reward-item-vnum-bundle.json`, or `docs/examples/bootstrap-invalid-open-cube-foreign-reward-item-vnum-bundle.json`, or `docs/examples/bootstrap-invalid-shop-preview-foreign-reward-item-vnum-bundle.json`, or `docs/examples/bootstrap-invalid-info-embedded-nul-text-bundle.json`), or other validation failures should be fixed in the bundle instead of imported into the live runtime
...
- if more than one item remains in the stack, the carried cell refreshes with the decremented count, preserves presence-aware instance sockets/attributes on that count-only remainder (including explicit zero; omitted keeps template-fallback encode; independent clone so later writes cannot alias the pre-use live inventory), and both item and non-item quickslots for that still-occupied cell remain unchanged
...
- [ ] If packet logging is available, repeat as a counted `ITEM_DROP2` partial-stack drop and confirm the source-slot `ITEM_UPDATE` preserves presence-aware instance sockets/attributes on that count-only remainder (including explicit zero; omitted keeps template-fallback encode) while updating only the remaining count; when the source stack carries presence-aware instance sockets/attributes, confirm owner pickup of that partial ground handle succeeds while the remainder still exists (fresh ground identity + independent clone), then confirm a whole-stack drop still moves the original identity with independent presence-aware sockets/attributes onto the pending ground handle (including explicit zero; omit→omit); then pick that whole-stack handle back up into the original free cell and confirm the placement `ITEM_SET` plus persisted inventory keep those instance fields instead of template fallback
...
Expected result:
- valid pickup removes the ground actor, refreshes the carried inventory slot or compatible stack according to the authored stack metadata, preserves destination presence-aware instance sockets/attributes on count-only compatible-stack `ITEM_UPDATE` merges (source/ground presence discarded; omitted destination keeps template-fallback encode), preserves template-authored socket/attribute display arrays in compatible-stack `ITEM_UPDATE` refreshes when instance presence is omitted, preserves presence-aware instance sockets/attributes on free-cell / original-slot restore `ITEM_SET` (including explicit zero; omitted keeps template-fallback encode; independent clone of the ground snapshot), preserves existing item/non-item quickslots for a compatible merge target cell, shows the normal pickup notice, closes any active same-socket exchange shell first with self/peer `GC::EXCHANGE END`, and does not produce a second/duplicate delayed ground-delete for the collector after the direct pickup response
...
- selected characters at the bootstrap zero-HP floor cannot pick up visible ground items or gold markers; `ITEM_PICKUP` fails closed with no item/gold pickup notice, inventory/gold mutation, or ground-handle removal; after `/restart_here` / `/restart_town` the same owner-side inventory-item pickup and the same gold pickup succeed normally again (`TestGameSessionFlowPostFloorItemPickupFailsClosed`, `TestGameSessionFlowPostFloorItemPickupFailsClosedBeforeRestartTown`, `TestGameSessionFlowPostFloorGoldPickupFailsClosed`, `TestGameSessionFlowPostFloorGoldPickupFailsClosedBeforeRestartTown`)
...
- if the target has only partial room, both source and target counts refresh as count-only `ITEM_UPDATE` frames that keep destination presence-aware instance sockets/attributes authoritative on the merged cell (including explicit zero; source presence discarded onto the destination; omitted destination keeps template-fallback encode) while the source remainder keeps an independent clone of source presence (not destination/template arrays), source and target item quickslots remain stable, and non-item quickslots with the same byte slot remain unchanged
- an exact counted or zero-count full-stack merge removes the source cell, refreshes the destination count with an `ITEM_UPDATE` that likewise keeps destination presence authoritative, deletes every source item quickslot in deterministic quickslot-position order, leaves target item quickslots stable, and leaves unrelated skill/command quickslots unchanged
...
Expected result:
- allowed equipment moves from carried inventory to the authored equipment cell, emits the self-only item refresh burst, deletes item quickslots bound to the cleared carried source cell, leaves unrelated skill/command quickslots with the same byte slot value unchanged, applies any template-authored `equip_effect` point change only after the matching item is actually equipped in that authored cell, and refreshes visible `CHARACTER_UPDATE.parts` for projected `body` / `weapon` / `head` / `hair` equipment; when the carried wearable has presence-aware instance sockets/attributes, empty wear-slot equip and occupied-wear replace equip-side must keep an independent clone of that presence on the worn cell through equipment `ITEM_SET` and the account snapshot (including explicit zero; omit→omit with template encode fallback; `docs/plans/2026-09-04-equip-preserve-instance-sockets-attributes.md`)
...
- [ ] If authoring or importing disposable interaction fixtures during the run, include the checked-in negative dry-run `docs/examples/bootstrap-invalid-info-embedded-nul-text-bundle.json` (`info.text` JSON `\u0000`) and confirm `/local/content-bundle/validate` rejects it before the content can be persisted or loaded; do not invent a throwaway NUL payload when that fixture is available
...
- selected characters at the bootstrap zero-HP floor cannot give items; `ITEM_GIVE` fails closed before anti-give feedback or mutation, and after `/restart_here` / `/restart_town` the same anti-give `ITEM_GIVE` against a visible living peer emits the ordinary self-only reject chat again (`TestGameSessionFlowPostFloorItemGiveFailsClosedBeforeAntiGiveFeedback`, `TestGameSessionFlowPostFloorItemGiveFailsClosedBeforeRestartTown`)
...
- [ ] After a successful preview for authored `probability` in `1..99`, confirm with a matching `REFINE` that has enough gold and materials; production draws one `crypto/rand` roll so manual QA cannot force an exact outcome — observe either the owned success burst (`RefineSuceeded <type>`, result `ITEM_SET`) or the owned failure burst (`RefineFailed <type>`). Without `keep_on_fail` / `fail_result_vnum`, failure destroys the source (`ITEM_DEL` + source quickslot sync). With authored `keep_on_fail`, failure keeps the source while still consuming materials/gold. Automated tests inject fixed rolls via `QueueRefineConfirmRollForTest`.
...
- selected characters at the bootstrap zero-HP floor cannot refine items; `REFINE` fails closed before template-authored reject feedback or mutation, and after `/restart_here` / `/restart_town` the same non-refineable template-backed `REFINE` emits the ordinary self-only reject chat again (`TestGameSessionFlowPostFloorItemRefineFailsClosedBeforeRejectFeedback`, `TestGameSessionFlowPostFloorItemRefineFailsClosedBeforeRestartTown`)
...
- after a successful preview for `probability` in `1..99`, a matching confirm draws one production `crypto/rand` roll (`1..100`) and routes to the owned success burst when `roll <= probability`; when `roll > probability` and both `keep_on_fail` / `fail_result_vnum` are omitted/false it uses the owned destroy burst (including destroy-source quickslot sync); when `roll > probability` and authored `keep_on_fail` is true it keeps the source while consuming materials/gold and still emits `RefineFailed <type>`; when `roll > probability`, `keep_on_fail` is false, and authored `fail_result_vnum` is non-zero it replaces the source cell with that fail-result `vnum` (`ITEM_SET`) while preserving the source instance id and any presence-aware instance sockets/attributes (including explicit zero; omitted stays omitted), consuming materials/gold, and still emitting `RefineFailed <type>`; manual QA cannot force an exact roll and should accept the owned outcome for the authored template; tests inject rolls via `QueueRefineConfirmRollForTest`
...
- item-template validation rejects `refine_info` without `refineable`, with a zero result `vnum`, negative cost, probability outside `0..100`, more than five materials, material rows with zero `vnum` / non-positive count, or `keep_on_fail` / non-zero `fail_result_vnum` when `probability` is `0` or `100`, both failure companions together, or `fail_result_vnum` equal to source/`result_vnum`
...
- this is still not a completed refine system: catalysts and broader window choreography remain deferred beyond the confirm-after-preview success seam, the deterministic `probability = 0` destroy + `RefineFailed` companion, the `1..99` injected-roll confirm seam, the template-authored `keep_on_fail` keep-failure companion, the template-authored `fail_result_vnum` downgrade companion, and the owned in-place success/downgrade presence-aware instance socket/attribute preserve
...
- [ ] If slash harness tooling is available, run `/open_safebox` and confirm one self-only `GC::SAFEBOX_SIZE` plus one self-only `GC::SAFEBOX_MONEY_CHANGE` (default `0` when no durable warehouse gold) appear without inventory/carried-gold mutation. The composed PvE vertical gameplay proof no longer uses that lab opener after `QuestGuide` re-unlock: reconnect already cleared the same-socket 10-second warehouse password reopen cooldown, so `SAFEBOX_CHECKIN` / `SAFEBOX_CHECKOUT` of turn-in `11200` now run through authored `Warehouse` `INTERACT` + `/safebox_password 000000` (`SAFEBOX_SIZE` size `2`). The same composed proof now also deposits authored drop-table `reward_gold = 60` with `/safebox_money_save` on the first unlocked warehouse open, rematerializes `SAFEBOX_MONEY_CHANGE` `60` after reconnect, then `/safebox_money_withdraw 60` before check-in/out
...
- [ ] After a successful warehouse open + `/close_safebox`, immediately re-interact and `/safebox_password` again and confirm self-only info chat `You cannot open the warehouse again so soon after closing it.` with no open frames; wait at least 10 seconds, then confirm the same password opens normally; lab `/open_safebox` during that cooldown still opens immediately. The composed PvE vertical gameplay proof now also hits that same-session cooldown reject after the first unlocked warehouse close (durable warehouse gold stays at deposited `reward_gold = 60`), then reopens through authored `Warehouse` `INTERACT` + `/safebox_password` after reconnect / `QuestGuide` re-unlock
...
- [ ] If QA fixtures can seed a carried item with presence-aware instance sockets (including explicit-zero `socket0=0`), check it into the warehouse, restart `gamed`, reopen `/open_safebox`, and confirm rematerialized `SAFEBOX_SET` keeps those sockets instead of template fallback; checkout should restore the same sockets into carried inventory
...
- after `/open_safebox`, a non-`anti_safebox` `SAFEBOX_CHECKIN` into an empty in-range `safe_pos` removes the carried item, syncs source item quickslots, stores an independent presence-aware sockets/attributes clone of that item (including explicit zero; omit→omit with template encode fallback) in the open-presentation table and durable same-account safebox FileStore, persists the inventory/quickslot account snapshot together with that safebox write, and emits self-only inventory removal plus `GC::SAFEBOX_SET` (sockets prefer instance `EffectiveSockets` including explicit zero over template sockets; attributes prefer instance `EffectiveAttributes` including explicit all-zero / type-zero); `/close_safebox` / `/safebox_close` clear the busy presentation flag with self-only `CHAT_TYPE_COMMAND` `CloseSafebox`, and a later `/open_safebox` (including after reconnect / process restart for the same login + character id) re-emits `SAFEBOX_SIZE` plus rematerialized `SAFEBOX_SET` rows with the same instance sockets/attributes; if a merchant window is open and the check-in would otherwise succeed, the client first sees self `GC::SHOP END`; if that carried source cell is currently displayed in an open exchange shell, check-in instead fails closed with no frames while the shell stays open/cancellable
- after `/open_safebox` with a remembered open-presentation safebox item, a `SAFEBOX_CHECKOUT` into an accepting carried destination removes that safebox cell from presentation + durable store, places/merges the whole stack into inventory while preserving item identity and presence-aware instance sockets/attributes on fresh-cell placement (including explicit zero; omit→omit with template encode fallback; independent clone so later writes cannot alias the safebox source), keeps compatible unlocked same-`vnum` merges count-only with destination presence authoritative, persists the inventory/quickslot account snapshot together with that safebox write, and emits self-only `GC::SAFEBOX_DEL` plus inventory `GC::ITEM_SET` / `GC::ITEM_UPDATE`; incompatible / locked / over-max / empty / closed / out-of-range attempts stay fail-closed with no frames; if an exchange shell is open and the check-out would otherwise succeed, the client first sees self/peer `GC::EXCHANGE END`; if a merchant window is open and the check-out would otherwise succeed, the client first sees self `GC::SHOP END`; if the destination carried cell is currently displayed in that open exchange shell, check-out stays fail-closed with no frames and does not close the shell
- after `/open_safebox` with a remembered open-presentation safebox item, a whole-stack `SAFEBOX_ITEM_MOVE` into an empty in-range safebox cell relocates that item while preserving identity and an independent presence-aware sockets/attributes clone (including explicit zero; omit→omit with template encode fallback) through relocate `SAFEBOX_SET` and same-session reopen, emitting self-only `GC::SAFEBOX_DEL` + `GC::SAFEBOX_SET`; a compatible same-`vnum` destination under template `max_count` merges the whole source count the same way; a partial-count move into an empty cell decrements the source and places a new-identity split stack with dual self-only `GC::SAFEBOX_SET`, cloning presence-aware instance sockets/attributes (including explicit zero) onto the destination so it cannot alias the source remainder while the source remainder keeps an independent clone of source presence (not destination/template arrays; `docs/plans/2026-09-06-safebox-item-move-partial-split-remainder-preserve-instance-sockets-attributes.md`), and a compatible partial merge refreshes both cells as count-only with destination presence-aware instance sockets/attributes remaining authoritative on the merged cell (including explicit zero; source presence discarded onto the destination; omitted destination stays omitted) while the source remainder keeps an independent clone of source presence (not destination/template arrays); the TMP4 client may pack both move positions with the inventory window type and safebox-slot cell bytes, and that wire is accepted the same way as explicit safebox-window tooling; carried inventory/equipment/quickslots/gold/account inventory persistence stay unchanged while the durable safebox FileStore updates; closed presentation, oversize counts, out-of-range/same-cell/unsupported windows, and incompatible destinations stay fail-closed with no frames; if an exchange shell is open and the move would otherwise succeed, the client first sees self/peer `GC::EXCHANGE END`; if a merchant window is open and the move would otherwise succeed, the client first sees self `GC::SHOP END`
- an `anti_safebox` carried item with template-authored `safebox_reject_message` returns exactly one self-only `CHAT_TYPE_INFO` message with that authored text on `SAFEBOX_CHECKIN`, while still leaving inventory, equipment, quickslots, points, gold, ground handles, and persistence unchanged; if a bootstrap merchant window is open on that same socket, the client first sees self `GC::SHOP END` and later `SHOP END` / `SHOP BUY` attempts fail closed until the merchant is reopened; if a bootstrap exchange shell is open on that same socket, the client first sees self `GC::EXCHANGE END`, the visible peer receives queued `GC::EXCHANGE END`, and no exchange item/gold display is finalized or mutated; selected characters at the bootstrap zero-HP floor cannot check items into storage; `SAFEBOX_CHECKIN` fails closed before anti-safebox feedback or mutation, and after `/restart_here` / `/restart_town` the same anti-safebox `SAFEBOX_CHECKIN` emits the ordinary self-only reject chat again (`TestGameSessionFlowPostFloorSafeboxCheckinFailsClosedBeforeAntiSafeboxFeedback`, `TestGameSessionFlowPostFloorSafeboxCheckinFailsClosedBeforeRestartTown`)
...
- this is still not a completed safebox or mall feature: mall / client `SAFEBOX_CHANGE_PASSWORD` packets / TMP4 CG `SAFEBOX_MONEY` request header remain deferred (tip-`0015`+`0025` safebox cell socket SQL and tip-`0015`+`0028` attribute SQL companions + seeded tip syncs are owned); warehouse password challenge + durable optional password + `/safebox_change_password` + durable warehouse money (`SAFEBOX_MONEY_CHANGE` + save/withdraw slashes) + same-account cell rematerialize (including presence-aware instance sockets) + `/safebox_password` 10-second post-close reopen cooldown + `ApproxDistance > 1000` open-anchor distance gate + already-open MOVE / SyncPosition walk-away `CloseSafebox` auto-close are owned for check-in/out/move
...
- [ ] If packet tooling allows it, repeat mutual-accept finalize with whole-stack free-cell placements that carry presence-aware instance sockets/attributes (including one explicit-zero sockets case) and confirm receiver `ITEM_SET` plus persisted inventory keep those instance fields instead of template fallback
...
- [ ] If packet tooling allows it, display an in-budget `ELK_ADD`, have that same side send `ACCEPT`, reduce that already-accepted side's live gold through a normal owned currency mutation such as gold drop, then have the paired side send the second `ACCEPT` and confirm dual-sided Check info-chat then self/peer `GC::EXCHANGE END` (shell cleared; no trade mutation)
...
- [ ] If packet tooling allows it, display one carried item, have that same side send `ACCEPT`, alter that already-accepted side's displayed live item or currently loaded item-template eligibility through a controlled/operator fixture, then have the paired side send the second `ACCEPT` and confirm dual-sided Check info-chat then self/peer `GC::EXCHANGE END` (shell cleared; no trade mutation)
- [ ] If packet tooling allows it, have one side display a carried item, have that side send `ACCEPT`, arrange the paired receiver so the displayed item cannot fit into carried inventory under the loaded template (full inventory with no compatible unlocked stack room, including the case where only locked compatible stacks remain), then have the receiver send the second `ACCEPT` and confirm dual-sided Space info-chat then self/peer `GC::EXCHANGE END` (shell cleared; no trade mutation)
- [ ] If packet tooling/operator fixtures allow it, have one side display a carried item whose item instance id also appears in the paired receiver's carried inventory or equipment, have the displayed side send `ACCEPT`, then have the receiver send the second `ACCEPT` and confirm dual-sided `Unknown error` then self/peer `GC::EXCHANGE END` (shell cleared; no trade mutation)
- [ ] If packet tooling/operator fixtures allow it, have one side display a stackable carried item, have that side send `ACCEPT`, arrange the paired receiver so an existing compatible carried stack for that same `vnum` already exceeds the loaded template's `max_count`, then have the receiver send the second `ACCEPT` and confirm dual-sided `Unknown error` then self/peer `GC::EXCHANGE END` (shell cleared; no trade mutation)
- [ ] If packet tooling allows it, have one side display in-budget `ELK_ADD`, have that side send `ACCEPT`, arrange the paired receiver so incoming displayed gold would overflow the current gold point-change carrier, then have the receiver send the second `ACCEPT` and confirm dual-sided gold-overflow info-chat then self/peer `GC::EXCHANGE END` (shell cleared; no trade mutation)
- [ ] While an exchange shell is open with a displayed item, open `/open_safebox` on the requester, then attempt `EXCHANGE ACCEPT` and confirm busy info-chat then self/peer `GC::EXCHANGE END` (shell cleared; inventory/gold unchanged; busy presentation stays open)
- [ ] While an exchange shell is open with a displayed item, open a merchant window on the requester, then attempt `EXCHANGE ACCEPT` and confirm busy info-chat then self/peer `GC::EXCHANGE END` (shell cleared; inventory/gold unchanged; busy presentation stays open)
- [ ] While an exchange shell is open with a displayed item, open `/open_safebox` on the paired partner before any accept marker, then attempt requester `EXCHANGE ACCEPT` and confirm busy info-chat then self/peer `GC::EXCHANGE END` (shell cleared)
- [ ] While an exchange shell is open with a displayed item, open a merchant window on the paired partner before any accept marker, then attempt requester `EXCHANGE ACCEPT` and confirm busy info-chat then self/peer `GC::EXCHANGE END` (shell cleared)
- [ ] While an exchange shell is open, have the first side `ACCEPT`, then open `/open_safebox` on the already-accepted partner before the second `ACCEPT`, and confirm the second accept emits busy info-chat then self/peer `GC::EXCHANGE END` (shell cleared; no trade mutation)
- [ ] While an exchange shell is open, have the first side `ACCEPT`, then open a merchant window on the already-accepted partner before the second `ACCEPT`, and confirm the second accept emits busy info-chat then self/peer `GC::EXCHANGE END` (shell cleared; no trade mutation)
...
- [ ] Note for QA tooling: commit-time busy-window / display / precondition drift after a second-accept finalize plan is built is covered by the shared-world `CommitExchangeFinalize` unit proof (`SharedWorldCommitExchangeFinalizeRejectsBusyWindowOpenedAfterAcceptPlan`) rather than a live mid-commit packet race; busy-window / gold-carrier drift returns the same self-only START/ACCEPT busy or gold-carrier info-chat strings to the commit requester then self/peer `GC::EXCHANGE END` (shell cleared); Check/Space/gold-overflow/Other remain dual-sided chat-then-`END`
- [ ] Note: accept-time `LESS_GOLD` displayed-gold rejects emit self `GC::EXCHANGE LESS_GOLD` then self/peer `GC::EXCHANGE END` (shell cleared); over-budget gold-add `LESS_GOLD` still leaves the shell cancellable
- [ ] If operator/test fixtures can force account persistence failure on either the first accepter or the second accepter during mutual-accept finalize, confirm dual-sided `Unknown error` then self/peer `GC::EXCHANGE END` (shell cleared), both inventories/gold/quickslots unchanged, and later `CANCEL` is a no-op
...
- `EXCHANGE ACCEPT` while the requester already holds gold at or above the owned signed point-change / bootstrap gold carrier max (`1<<31-1`) fails closed with one self-only info-chat `You have more than 2 Billion Yang. You cannot trade.` then self/peer `GC::EXCHANGE END` (shell cleared), leaves inventory/equipment/quickslots/gold/persistence unchanged; this gate is evaluated after the owned busy-window rejects and before Check/Space finalization preconditions
- `EXCHANGE ACCEPT` while only the paired partner already holds gold at or above that same carrier max fails closed with one self-only info-chat `The player has more than 2 Billion Yang. You cannot trade with him.` then self/peer `GC::EXCHANGE END` (shell cleared); when both sides are over the cap, the requester-side string wins
- if either paired side's live gold drifts to or above `1<<31-1` after a second-accept finalize plan is built but before shared-world commit applies, mutual-accept finalize fails closed with one self-only gold-carrier-cap info-chat to the commit requester (`You have more than 2 Billion Yang. You cannot trade.` when that requester is over the cap, otherwise `The player has more than 2 Billion Yang. You cannot trade with him.`) then self/peer `GC::EXCHANGE END` (shell cleared); no durable trade mutation
- `EXCHANGE ACCEPT` while the requester already has an open same-socket merchant window, `/open_safebox` presentation, or refine-dialog presentation fails closed with one self-only info-chat `You cannot trade while another trade window is open.` then self/peer `GC::EXCHANGE END` (shell cleared), leaves that busy presentation open, and leaves inventory/equipment/quickslots/gold/persistence unchanged
- `EXCHANGE ACCEPT` (including second accept / mutual-accept finalize) while the paired partner currently has an open bootstrap merchant window, `/open_safebox` presentation, or refine-dialog presentation fails closed with one self-only info-chat `That player cannot trade right now.` then self/peer `GC::EXCHANGE END` (shell cleared), leaves the partner busy presentation open, and leaves inventory/equipment/quickslots/gold/persistence unchanged
- if either paired side opens a merchant / safebox / refine busy presentation after a second-accept finalize plan is built but before shared-world commit applies, mutual-accept finalize fails closed with one self-only busy info-chat to the commit requester (`You cannot trade while another trade window is open.` when that requester is busy, otherwise `That player cannot trade right now.`) then self/peer `GC::EXCHANGE END` (shell cleared), rolls back any already-written account/live snapshots from that finalize attempt; live displayed item/gold Check drift at that same commit gate emits dual-sided info-chat (`Not enough Yang or the item is not in place.` / `The other player does not have enough Yang or their item is not in place.`) then self/peer `GC::EXCHANGE END` auto-cancel with the same rollback contract; inventory-capacity drift emits dual-sided Space info-chat (`There isn't enough space in your inventory.` / `The other person has no space left in their inventory.`) then the same auto-cancel; gold-overflow finalization precondition drift emits dual-sided info-chat (`You cannot carry any more gold.` / `The other person cannot carry any more gold.`) then the same auto-cancel; other receiver finalization precondition drift (item-id collision, over-template-max, locked-compatible-stack capacity, selected-character restrictions) emits dual-sided `CHAT_TYPE_INFO` `Unknown error` then the same auto-cancel (`docs/plans/2026-08-28-exchange-finalize-reject-auto-cancel.md`)
...
- allowed active-shell `EXCHANGE ITEM_ADD` emits one self `GC::EXCHANGE ITEM_ADD` with `is_me = 1` and one queued peer `GC::EXCHANGE ITEM_ADD` with `is_me = 0`; both frames carry the carried item `vnum`, exchange display slot, count, sockets from instance `EffectiveSockets` when present (including explicit zero) else template sockets, and attributes from instance `EffectiveAttributes` when present (including explicit all-zero / type-zero) else template attributes, but the item remains in carried inventory and is not removed or persisted as traded (`docs/plans/2026-08-28-exchange-item-add-instance-sockets.md`, `docs/plans/2026-08-30-attributes-on-instance-contract-freeze.md`). While that carried item identity remains displayed, same-socket mutations that would change it (`ITEM_USE`, carried `ITEM_MOVE` / equip/unequip, `ITEM_USE_TO_ITEM`, `ITEM_DROP` / `ITEM_DROP2`, merchant sell of that cell, `SAFEBOX_CHECKIN` of that displayed source cell, and `SAFEBOX_CHECKOUT` into that displayed destination cell) fail closed with no frames and leave the exchange shell open; `ITEM_DEL`, cancel/close, death/walk-away/lifecycle teardown, and successful mutual-accept finalize clear that display lock
...
- if either account persistence write fails during mutual-accept finalize, the trade fails closed with dual-sided `CHAT_TYPE_INFO` `Unknown error` then self/peer `GC::EXCHANGE END` (shell cleared), both live and persisted inventory/equipment/quickslot/gold snapshots stay unchanged, and later `CANCEL` is a no-op
...
- `CG::MYSHOP` (`0x0802`) encode/decode plus GAME dispatch are owned in this bootstrap: the default remains deny-no-response, and the first host-only accepted private-shop open presentation is now live (sign/stock/busy/armor/cash/equipped/locked/gold gates + bag branch (prefer unlisted silk bag `71049` → bag-less `SHOP_SIGN` with no inventory mutation and process-local remembered unit prices for later silk-bag USE; else require/consume ordinary shop-bag `50200` with bag refresh then `SHOP_SIGN`) + same-socket open/busy flag; missing/listed-only/locked-only bag stays silent; listed stock itself is not removed on open (`docs/plans/2026-08-27-myshop-silk-bag-71049-consume-skip.md`, `docs/plans/2026-08-27-myshop-shop-bag-50200-require-consume.md`)); carried `50200` / `71049` `ITEM_USE` / `/use_item` opens the private-shop setup UI via self-only `CHAT_TYPE_COMMAND` (`OpenPrivateShop`; first silk USE also rematerializes `MyShopPriceList` including dummy `1 0` when empty) without consuming the bag (`docs/plans/2026-08-28-myshop-bag-use-openprivateshop-pricelist.md`); accepted open deactivates listed auto-potion `socket0` (`72723..72730` with effective `socket0 == 1` → `0`) via minimal instance sockets and emits self-only `ITEM_UPDATE` after any bag refresh and before exchange `END` / live `SHOP_SIGN` (`docs/plans/2026-08-28-myshop-open-auto-potion-socket0-deactivate.md`); host-only empty-sign `GC::SHOP_SIGN` clear/close is also live on `/phase_select` / `/quit` / `/logout`, practice-mob floor, transfer/warp, and lab `/close_myshop`; visible peers now receive the same live/empty `SHOP_SIGN` around-broadcast on open/close, and newly visible peers rematerialize one live `SHOP_SIGN` for an already-open host; guest browse open is now live via peer `CG::ON_CLICK` on that host VID → one guest-only `GC::SHOP START` stock table (busy merchant/safebox/refine/exchange rejects reuse the owned exchange busy info-chat strings; guest own open MYSHOP / closed host stay silent); guest leave is now live via `CG::SHOP END` → one guest-only `GC::SHOP END` (host empty-sign / guest lifecycle also clear browse with one guest END); guest private-shop buy is now live (`docs/plans/2026-08-24-myshop-guest-buy-mutation-contract-freeze.md`): browsing `CG::SHOP BUY` transfers live host stock/gold with guest `UPDATE_ITEM(vnum=0)` and fail-closed distance/sold-out/inventory-full/insufficient-gold; multi-guest sold-slot fan-out to other browsing guests is also owned (`docs/plans/2026-08-24-myshop-guest-buy-multi-guest-update-item-fanout.md`); guest `SHOP SELL` / `SELL2` while browsing are owned fail-closed (`docs/plans/2026-08-25-myshop-guest-sell-while-browsing-fail-closed.md`); open-cube busy rejects are owned; partner open-private-shop exchange START/ACCEPT/commit busy rejects are now owned beside merchant/safebox/refine; open MYSHOP also locks host item use/move/drop/pickup/give/safebox/refine mutations fail-closed until empty-sign close; host open requires one unlisted carried `50200` shop bag on success (`docs/plans/2026-08-27-myshop-shop-bag-50200-require-consume.md`); host open reject chat now covers worn body armor (`You must unequip your armor to open a private shop.`), `anti_give|anti_myshop` stock (`Cash items cannot be sold in a private shop.`), locked stock (`Items currently in use cannot be sold in a private shop.`), and gold-overflow (`You cannot open a private shop because it would exceed 2 Billion Yang.`) while structural empty-sign / missing-cell rejects stay silent (`docs/plans/2026-08-26-myshop-open-reject-chat-hardening.md`); host open banword sign reject is live with self-only INFO `You can't give your shop an invalid name.` after armor and before stock walk (`docs/plans/2026-08-27-myshop-open-banword-sign-reject.md`); authored `myshop_reject_message` for cash-item open stock is live and overrides `Cash items cannot be sold in a private shop.` when present (`docs/plans/2026-08-27-myshop-open-myshop-reject-message.md`); gold-overflow gate now fires after armor and before banword/stock (`docs/plans/2026-08-27-myshop-open-gold-overflow-gate-reorder.md`); already-open second open → empty-sign close is now live (`docs/plans/2026-08-27-myshop-open-already-open-second-open-empty-sign-close.md`); accepted open while an exchange shell is open cancels that shell first (ordinary bag → bag refresh → self/peer `GC::EXCHANGE END` → live `SHOP_SIGN`; silk → self/peer `END` → live `SHOP_SIGN`) instead of busy-rejecting (`docs/plans/2026-08-28-myshop-open-cancel-active-exchange.md`); armor/gold/banword/cash/equipped/locked/missing-bag/merchant|safebox|refine|cube busy rejects leave any open exchange shell cancellable; keep treating tax/empire multipliers as out of scope for playable PvE checks
...
- Migration-shaped tip-`0003` character-item-state export/quarantine/import now carries presence-aware instance sockets (`has_sockets` + `socket0/1/2`) via additive catalog `0024_character_item_instance_sockets` and presence-aware instance attributes via additive `0027_character_item_instance_attributes` (export identity stays tip-`0003`; SQL import requires tip `3` + `24` + `27`). Ops: confirm `GET /local/db/migrations/catalog` tips at `29` / `bootstrap_ground_item_instance_attributes` (tip-`0003` still owns additive `0024`/`0027`) and that quarantined item-state rows keep deactivated auto-potion `socket0 = 0` when `has_sockets = true`.
...
- Account FileStore rematerialize round-trips the same presence-aware instance sockets on carried inventory/equipment across `gamed` restart → EnterGame `ITEM_SET` even when the post-restart login ticket still omits sockets (`TestGameRuntimeCarriedItemInstanceSocketsRematerializeAcrossDaemonRestart`; active / explicit-zero / omitted→template-fallback); see [carried item instance-sockets daemon-restart rematerialize](../plans/2026-08-31-carried-item-instance-sockets-daemon-restart-rematerialize.md).
- Account FileStore rematerialize likewise round-trips presence-aware instance attributes on carried inventory/equipment across restart → EnterGame `ITEM_SET` under a stale attribute-less ticket (`TestGameRuntimeCarriedItemInstanceAttributesRematerializeAcrossDaemonRestart`; see [carried item instance-attributes daemon-restart rematerialize](../plans/2026-08-31-carried-item-instance-attributes-daemon-restart-rematerialize.md)).
- Durable ground-item FileStore rematerialize also round-trips presence-aware instance attributes (`has_attributes` + `attributes`, including explicit all-zero / type-zero) across drop → `gamed` restart → pickup (`TestGameRuntimePendingGroundItemInstanceAttributesRematerializeAcrossDaemonRestart`); gold markers stay attribute-less; tip-`0010` SQL attribute companion (`0029`) + seeded hermetic tip-`0010`+`0029` import-export drill are owned (`docs/plans/2026-08-31-bootstrap-ground-item-instance-attributes-sql-additive.md`, `docs/plans/2026-08-31-seeded-ground-item-instance-attributes-import-export-drill.md`).
- Durable safebox FileStore cells rematerialize the same presence-aware instance sockets across check-in → `gamed` restart → reopen / checkout (`TestGameRuntimeSafeboxCheckinInstanceSocketsRematerializeAcrossDaemonRestart`); tip-`0015`+`0025` SQL additive + seeded tip sync are owned. Presence-aware **instance attributes** are now owned for account FileStore + live encode preference (`ITEM_SET` / `ITEM_UPDATE` / open-presentation `SAFEBOX_SET` / exchange `ITEM_ADD` / guest MYSHOP browse prefer `EffectiveAttributes`, including explicit all-zero / type-zero) beside owned instance sockets (`docs/plans/2026-08-30-attributes-on-instance-contract-freeze.md`). Durable safebox FileStore cells also rematerialize those instance attributes (`has_attributes` + `attributes`) across check-in → restart → reopen / checkout (`TestGameRuntimeSafeboxCheckinInstanceAttributesRematerializeAcrossDaemonRestart`); tip-`0015`+`0028` SQL attribute companion + seeded hermetic tip sync are owned beside tip-`0015`+`0025` sockets.
...
Expected result:
- one successful guest buy transfers live host stock and gold without bare `GC::SHOP OK`, keeps browse open until leave/host close, and clears the sold display slot for remaining guests; whole-stack free-cell placements carry the host live presence-aware instance sockets/attributes (including explicit zero) into the guest `ITEM_SET` and persisted inventory, while compatible-stack merges stay count-only with destination presence authoritative (`docs/plans/2026-09-03-myshop-guest-buy-preserve-instance-sockets-attributes.md`, `docs/plans/2026-09-03-compatible-stack-merge-destination-wins-instance-sockets-attributes.md`)
...
- [ ] If authored QA NPC content is loaded (`docs/examples/bootstrap-npc-service-bundle.json`), inspect `GET /local/interaction-visibility/{character}` before interacting and confirm the visible `CubeMaster` `open_cube` actor previews `Quest requirements are not met.` while `quest:first_steps` / `met_guide` is unset, with no quest-state mutation
...
- [ ] After satisfying that gate (for example via the owned quest-flag NPC path), interact with `CubeMaster` again and confirm optional self-only info chat `The craftsman lights the forge.` plus command chat `cube open 20022`. Then `/cube r_info` emits `cube r_list 20022 1 27001,1` and `/cube r_info 0` emits `cube m_info 0 1 27002,2/100` from the authored bundle `cube_recipes` (`docs/plans/2026-09-06-pve-vertical-authored-cube-recipes.md`). Operators can also inspect `GET /local/content-bundle/open-cube-routes/CubeMaster` or `GET /local/content-bundle/maps/1/open-cube-routes` for the authored race_num/gate placement without opening cube in-game; a second interact after the 1s cooldown while still open must emit `The Build window is already open.` without a second open. The composed PvE vertical gameplay proof (`TestPveVerticalAuthoringBundleClosesGuideUnlockKillCreditAndTurnIn`) now also `/cube r_info` / `/cube r_info 0` on that authored window (`cube r_list 20022 1 27001,1` / `cube m_info 0 1 27002,2/100`, no gold/inventory mutation) before `/close_cube` (`docs/plans/2026-09-06-pve-vertical-authored-cube-r-info.md`)
...
- [ ] With `/open_cube` already open, `/cube r_info` emits one self-only command chat `cube r_list 20022 1 27001,1` with no inventory/gold mutation (`docs/plans/2026-08-25-cube-r-info-result-list-implementation.md`). When authored QA content is loaded (`docs/examples/bootstrap-pve-vertical-authoring-bundle.json` or `docs/examples/bootstrap-npc-service-bundle.json`), that row comes from bundled `cube_recipes` rather than the lab fallback (`docs/plans/2026-09-06-pve-vertical-authored-cube-recipes.md`). The composed PvE vertical gameplay proof now also proves that same `r_list` after authored `CubeMaster` `INTERACT` rather than only the lab `/open_cube` opener
- [ ] Confirm `/cube r_info` while cube is closed stays silent/no-frame. The composed PvE vertical gameplay proof now also proves that closed-window silence after `/close_cube` on the authored CubeMaster path
- [ ] Confirm `/open_cube 20017` then `/cube r_info` stays silent when that NPC has no authored recipes
- [ ] With `/open_cube` already open, `/cube r_info 0` emits one self-only command chat `cube m_info 0 1 27002,2/100` with no inventory/gold mutation (`docs/plans/2026-08-25-cube-m-info-material-info-implementation.md`). The composed PvE vertical gameplay proof now also proves that same `m_info` on the authored CubeMaster window before close
...
- [ ] With `/open_cube` already open and bootstrap materials in inventory (two cells of `27002` count `1`, or one cell count `2`), `/cube add` matching the authored materials emits self-only `cube info 100 0 0` with no inventory/gold mutation (`docs/plans/2026-08-25-cube-add-del-slot-binding-implementation.md`)
- [ ] Confirm `/cube del <cubeIndex>` on an occupied craft slot emits `cube info 0 0 0` when the remaining set no longer matches
- [ ] Confirm closed-cube / out-of-range / empty-cell / malformed `/cube add` / `/cube del` stay silent/no-frame, and close clears bindings so reopen starts empty
- [ ] With matching materials bound via `/cube add`, `/cube make` consumes materials/gold for `percent = 100`, grants the authored reward, emits `cube success <vnum> <count>` plus follow-up `cube info`, and persists inventory/gold (`docs/plans/2026-08-25-cube-make-percent-100-implementation.md`)
- [ ] Confirm closed-cube / unmatched / insufficient-gold / inventory-full `/cube make` stay fail-closed without mutation; other `/cube make` extra args stay silent
- [ ] For authored `percent` in `1..99`, `/cube make` draws one production roll so manual QA cannot force an exact outcome — observe either the owned success burst (`cube success`) or the owned fail burst (`You have failed to craft the item.` + `cube fail`) after materials/gold are consumed (`docs/plans/2026-08-26-cube-make-percent-1-99-injected-roll.md`). Automated tests inject fixed rolls via `QueueCubeMakeRollForTest`.
- [ ] With enough matching materials for two `percent = 100` crafts, `/cube make all` concatenates two success bursts then stops with the unmatched-materials info chat after materials run out (`docs/plans/2026-08-26-cube-make-all-loop.md`); a fail-roll attempt stops the loop after that fail burst
- [ ] For authored `percent = 0`, `/cube make` / `/cube make all` consume materials/gold and emit the owned fail burst without granting a reward (`docs/plans/2026-08-26-cube-make-percent-0-always-fail.md`); bootstrap recipes stay `percent = 100`, so this needs an authored override for manual QA
- [ ] With materials bound via `/cube add`, `/cube list` emits one self-only info chat per bound slot shaped `cube[<i>]: inventory[<cell>]: <template.name>` with no inventory/gold mutation (`docs/plans/2026-08-26-cube-list-cancel.md`)
- [ ] Confirm empty open-cube `/cube list`, closed-cube `/cube list`, and `/cube list extra` stay silent/no-frame
- [ ] Confirm `/cube cancel` and `/cube close` each emit one `cube close` command chat and clear bindings/busy bit the same way `/close_cube` does; already-closed cancel/close stay silent

Expected result:
- lab cube open/close is command-chat only (no binary cube packet), inventory/gold stay unchanged, and open cube rejects exchange `START` / `ACCEPT` / commit, host `CG::MYSHOP` open, guest browse open, `/open_safebox` / successful `/safebox_password`, and refine confirm with the already-owned requester/partner busy chat strings or silent confirm fail-closed (`docs/plans/2026-08-25-exchange-cube-busy-window-reject-chat.md`, `docs/plans/2026-08-25-myshop-safebox-refine-cube-busy-rejects.md`); guest `SHOP SELL` / `SELL2` while browsing are owned fail-closed (`docs/plans/2026-08-25-myshop-guest-sell-while-browsing-fail-closed.md`); open cube `/cube r_info` emits authored `cube r_list` without mutation (`docs/plans/2026-08-25-cube-r-info-result-list-implementation.md`); `/cube r_info <index> [count]` emits authored `cube m_info` without mutation (`docs/plans/2026-08-25-cube-m-info-material-info-implementation.md`); the composed PvE vertical gameplay proof now also inspects authored `CubeMaster` with those same non-mutating `r_list` / `m_info` bursts before `/close_cube` (`docs/plans/2026-09-06-pve-vertical-authored-cube-r-info.md`); craft-slot `/cube add` / `/cube del` emit authored `cube info <gold> 0 0` without inventory mutation (`docs/plans/2026-08-25-cube-add-del-slot-binding-implementation.md`); `/cube make` (`percent = 100`) consumes bound materials/gold, grants the reward, and emits `cube success` (`docs/plans/2026-08-25-cube-make-percent-100-implementation.md`); `/cube make` for authored `percent` in `1..99` consumes materials/gold then either grants + `cube success` or emits fail info + `cube fail` (`docs/plans/2026-08-26-cube-make-percent-1-99-injected-roll.md`); `/cube make` / `/cube make all` for authored `percent = 0` always fail after consume (`docs/plans/2026-08-26-cube-make-percent-0-always-fail.md`); `/cube make all` loops while each craft succeeds (`docs/plans/2026-08-26-cube-make-all-loop.md`); `/cube list` dumps bound slots as INFO chat and `/cube cancel` / `/cube close` alias `/close_cube` (`docs/plans/2026-08-26-cube-list-cancel.md`); complicated OR-materials stay deferred
...
- import/adapt `docs/examples/bootstrap-pve-vertical-authoring-bundle.json` when validating the authoring-form regen/drop + quest loop (validate/import expands it into the same owned runtime content, including the gated `Warehouse` `open_safebox` actor, gated `CubeMaster` `open_cube` actor, gated `VillageGuide` `talk` / `VillageSignpost` `info` chat, and gated same-map `Teleporter` `warp`; the checked-in expanded twin is `docs/examples/bootstrap-pve-vertical-canonical-bundle.json`), or
...
- [ ] `POST /local/content-bundle/import-preview` with the same candidate JSON and confirm the no-mutation `current` / `candidate` summaries plus top-level and per-map deltas identify the maps, exact static-actor/spawn-group rows, map-local quest-flag/shop-route/warp-route/open-safebox-route/open-cube-route rows, grouped reward-drop changes by item vnum, interaction-kind count/reference changes, interaction-definition preview changes, combat-profile changes, shop-route changes, warp-destination/route changes, open-safebox-route changes, open-cube-route changes, quest-state flag/character/quest-count changes, and service actor/spawn/reward counts that would change; when only one authored map, interaction kind, interaction definition, interactable actor preview, merchant route, teleporter route, warehouse route, spawn group, combat profile, or reward item matters, use `POST /local/content-bundle/import-preview/maps/{map_index}`, `POST /local/content-bundle/import-preview/interaction-kinds/{kind}`, `POST /local/content-bundle/import-preview/interaction-definitions/{kind}/{ref}`, `POST /local/content-bundle/import-preview/interactable-static-actors/{name}`, `POST /local/content-bundle/import-preview/quest-flag-triggers/{kind}/{ref}`, `POST /local/content-bundle/import-preview/quest-flag-routes/{actor_name}`, `POST /local/content-bundle/import-preview/shop-routes/{actor_name}`, `POST /local/content-bundle/import-preview/warp-routes/{actor_name}`, `POST /local/content-bundle/import-preview/open-safebox-routes/{actor_name}`, `POST /local/content-bundle/import-preview/open-cube-routes/{actor_name}`, `POST /local/content-bundle/import-preview/spawn-groups/{ref}`, `POST /local/content-bundle/import-preview/combat-profiles/{profile}`, or `POST /local/content-bundle/import-preview/reward-drops/{item_vnum}` to inspect that exact delta without filtering the broad preview
- [ ] `POST /local/content-bundle/validate` with the same JSON and confirm the pretty-printed canonical bundle response matches the intended authored content; for `docs/examples/bootstrap-npc-service-bundle.json`, the response should be byte-for-byte identical to the checked-in fixture. If testing `docs/examples/bootstrap-pve-vertical-authoring-bundle.json`, confirm validation expands authoring-only `regen_spawns` / `drop_tables` into the checked-in byte-canonical twin `docs/examples/bootstrap-pve-vertical-canonical-bundle.json` (stripped authoring collections, denser pack members, formula profile, gated Warehouse, gated CubeMaster). If testing `docs/examples/bootstrap-drop-table-authoring-bundle.json`, confirm validation expands authoring-only `drop_tables` / `reward_drop_table_ref` into canonical `spawn_groups[].reward_experience`, `spawn_groups[].reward_gold`, sorted `spawn_groups[].reward_drop_vnums`, and the table-authored kill-quest credit fields including the optional require gate (`reward_quest_ref`, `reward_quest_flag`, `reward_quest_to`, `reward_quest_text`, `require_quest_ref`, `require_quest_flag`, `require_quest_from`), and returns no top-level `drop_tables`. If testing `docs/examples/bootstrap-kill-quest-only-drop-table-authoring-bundle.json`, confirm validation expands the gated kill-quest-only table (empty EXP/gold/drop channels, no item templates) into one canonical `spawn_groups[]` row carrying only the kill-quest credit + require-gate fields, strips `drop_tables` / `reward_drop_table_ref`, and retains the minimal `quest:first_steps.met_guide` `quest_flag` writer. If testing `docs/examples/bootstrap-kill-quest-only-regen-authoring-bundle.json`, confirm validation expands one-count `regen_spawns` plus the gated kill-quest-only table (empty EXP/gold/drop channels, no item templates) into one canonical `spawn_groups[]` row carrying only the kill-quest credit + require-gate fields, strips `regen_spawns` / `drop_tables` / `reward_drop_table_ref`, and retains the same `met_guide` writer. If testing `docs/examples/bootstrap-regen-authoring-bundle.json`, confirm validation expands `regen_spawns` with `count = 1` plus the fixed reward table into one canonical `spawn_groups[]` row carrying the table-authored kill-quest credit fields including the optional require gate (`reward_quest_ref`, `reward_quest_flag`, `reward_quest_to`, `reward_quest_text`, `require_quest_ref`, `require_quest_flag`, `require_quest_from`), and strips `regen_spawns`, `drop_tables`, and `reward_drop_table_ref`. If testing `docs/examples/bootstrap-multi-count-regen-authoring-bundle.json`, confirm validation expands `count = 2` + `pack_spacing = 100` into two independent members (`practice.qa_multi_regen_mob.m01` at the authored origin and `.m02` at `x+100`) that share the table-authored rewards/kill-quest gate, then strips `regen_spawns`, `drop_tables`, `reward_drop_table_ref`, and `pack_spacing`. If testing `docs/examples/bootstrap-pve-vertical-authoring-bundle.json`, confirm validation expands the composed `regen_spawns` + gated `drop_tables` + quest NPC loop into three canonical `spawn_groups[]` rows: gated kill-quest `practice.qa_pve_vertical_mob` plus denser pack members `practice.qa_pve_vertical_pack.m01` / `.m02` (`count = 2`, `pack_spacing = 100`), all bound to formula profile `qa_pve_vertical_practice_mob` (`max_hp = 20`, derived `damage_per_normal_attack = 5`) plus the portable `combat_profiles[]` row and the same quest-flag/service definitions, while stripping authoring-only `regen_spawns` / `drop_tables` / `reward_drop_table_ref` / `pack_spacing`. If testing `docs/examples/bootstrap-combat-profile-formula-bundle.json`, confirm validation expands the formula-first `qa_formula_practice_mob` profile into derived `damage_per_normal_attack = 5` and default `level = 1`, copies the profile-default death reward onto `practice.qa_formula_mob`, and keeps the portable `combat_profiles[]` row. If the candidate includes duplicate reward drop vnums in `spawn_groups`, `regen_spawns`, `drop_tables`, or bundled `combat_profiles[].death_reward.drop_vnums`, validation should fail before import. For deterministic negative dry-runs without improvising JSON, `POST /local/content-bundle/validate` with `docs/examples/bootstrap-invalid-regen-count-bundle.json` (`count = 2` without `pack_spacing`), `docs/examples/bootstrap-invalid-regen-over-max-count-bundle.json` (`count = 9`), `docs/examples/bootstrap-invalid-regen-one-count-pack-spacing-bundle.json` (`count = 1` with `pack_spacing = 100`), or `docs/examples/bootstrap-invalid-colliding-regen-member-refs-bundle.json` (authored `spawn_groups` already owns a synthesized `{ref}.m01` member that multi-count expansion would recreate), or `docs/examples/bootstrap-invalid-orphan-quest-gate-bundle.json` (gated kill-quest-only table missing the `met_guide` writer), or `docs/examples/bootstrap-invalid-orphan-service-quest-gate-bundle.json` (gated `shop_preview` missing the `met_guide` writer), or `docs/examples/bootstrap-invalid-empty-drop-table-bundle.json` (completely empty `drop_tables` row with no combat channels and no kill-quest credit), or `docs/examples/bootstrap-invalid-conflicting-kill-quest-credit-bundle.json` (spawn group already authors kill-quest credit and also expands a kill-quest-bearing `drop_tables` row), or `docs/examples/bootstrap-invalid-orphan-require-quest-from-bundle.json` (complete kill-quest credit plus orphan `require_quest_from` without both require identities), or `docs/examples/bootstrap-invalid-partial-require-quest-gate-bundle.json` (complete kill-quest credit plus partial require gate `require_quest_ref` without `require_quest_flag`), or `docs/examples/bootstrap-invalid-reverse-partial-require-quest-gate-bundle.json` (complete kill-quest credit plus reverse partial require gate `require_quest_flag` without `require_quest_ref`), or `docs/examples/bootstrap-invalid-partial-kill-quest-credit-bundle.json` (incomplete kill-quest credit missing `reward_quest_text`), or `docs/examples/bootstrap-invalid-kill-quest-from-equals-to-bundle.json` (complete kill-quest credit with `reward_quest_from == reward_quest_to`), or `docs/examples/bootstrap-invalid-partial-drop-table-kill-quest-credit-bundle.json` (drop-table incomplete kill-quest credit missing `reward_quest_text`), or `docs/examples/bootstrap-invalid-quest-state-seed-alone-gate-writer-bundle.json` (gated `talk` backed only by portable `quest_state` seed rows, no `quest_flag` / kill-quest writer), or `docs/examples/bootstrap-invalid-partial-service-quest-gate-bundle.json` (service `talk` with partial quest gate `quest_ref` without `quest_flag`), or `docs/examples/bootstrap-invalid-reverse-partial-service-quest-gate-bundle.json` (service `talk` with reverse partial quest gate `quest_flag` without `quest_ref`), or `docs/examples/bootstrap-invalid-orphan-service-quest-from-bundle.json` (ungated service `talk` with orphan `quest_from`), or `docs/examples/bootstrap-invalid-orphan-service-quest-to-bundle.json` (ungated service `talk` with orphan `quest_to`), or `docs/examples/bootstrap-invalid-gated-service-quest-to-bundle.json` (gated service `talk` with complete quest gate plus mutating `quest_to`), or `docs/examples/bootstrap-invalid-dangling-interaction-ref-bundle.json` (static actor `talk` metadata pointing at a missing interaction definition), or `docs/examples/bootstrap-invalid-unsupported-interaction-kind-bundle.json` (static actor `quest` metadata that is not an owned interaction kind), or `docs/examples/bootstrap-invalid-duplicate-static-actor-bundle.json` (two portable static-actor rows that collide after canonical trimming), or `docs/examples/bootstrap-invalid-reward-drop-without-item-templates-bundle.json` (spawn-group item-shaped `reward_drop_vnums` with no bundled `item_templates`), or `docs/examples/bootstrap-invalid-reward-drop-item-missing-from-item-templates-bundle.json` (spawn-group item-shaped `reward_drop_vnums` whose vnum is absent from a present but incomplete `item_templates` collection), or `docs/examples/bootstrap-invalid-combat-profile-death-reward-item-missing-from-item-templates-bundle.json`, `docs/examples/bootstrap-invalid-combat-profile-death-reward-without-item-templates-bundle.json` (portable `combat_profiles[].death_reward.drop_vnums` whose vnum is absent from a present but incomplete `item_templates` collection), or `docs/examples/bootstrap-invalid-merchant-catalog-without-item-templates-bundle.json` (`shop_preview` catalog with no bundled `item_templates`), or `docs/examples/bootstrap-invalid-merchant-catalog-item-missing-from-item-templates-bundle.json` (`shop_preview` catalog whose `item_vnum` is absent from a present but incomplete `item_templates` collection), or `docs/examples/bootstrap-invalid-quest-flag-reward-item-missing-from-item-templates-bundle.json` (`quest_flag` turn-in `reward_items` whose `item_vnum` is absent from a present but incomplete `item_templates` collection), or `docs/examples/bootstrap-invalid-quest-flag-reward-item-without-item-templates-bundle.json` (`quest_flag` turn-in `reward_items` with no bundled `item_templates`), or `docs/examples/bootstrap-invalid-quest-flag-consume-item-missing-from-item-templates-bundle.json` (`quest_flag` turn-in `consume_items` whose `item_vnum` is absent from a present but incomplete `item_templates` collection), or `docs/examples/bootstrap-invalid-quest-flag-consume-item-without-item-templates-bundle.json` (`quest_flag` turn-in `consume_items` with no bundled `item_templates`), or `docs/examples/bootstrap-invalid-quest-flag-reward-item-count-above-stack-limit-bundle.json` (`quest_flag` turn-in `reward_items` whose `count` exceeds the bundled template `max_count`), or `docs/examples/bootstrap-invalid-quest-flag-reward-item-count-above-non-stackable-limit-bundle.json` (`quest_flag` turn-in `reward_items` whose `count` exceeds `1` for a non-stackable bundled template), or `docs/examples/bootstrap-invalid-quest-flag-consume-item-count-above-stack-limit-bundle.json` (`quest_flag` turn-in `consume_items` whose `count` exceeds the bundled template `max_count`), or `docs/examples/bootstrap-invalid-quest-flag-consume-item-count-above-non-stackable-limit-bundle.json` (`quest_flag` turn-in `consume_items` whose `count` exceeds `1` for a non-stackable bundled template), or `docs/examples/bootstrap-invalid-open-cube-foreign-size-bundle.json` (`open_cube` definition with illegal warehouse `size`), or `docs/examples/bootstrap-invalid-open-cube-foreign-title-bundle.json` (`open_cube` definition with illegal merchant `title`), or `docs/examples/bootstrap-invalid-open-safebox-foreign-title-bundle.json` (`open_safebox` definition with illegal merchant `title`), or `docs/examples/bootstrap-invalid-open-safebox-foreign-catalog-bundle.json` (`open_safebox` definition with illegal merchant `catalog`), or `docs/examples/bootstrap-invalid-open-cube-foreign-catalog-bundle.json` (`open_cube` definition with illegal merchant `catalog`), or `docs/examples/bootstrap-invalid-open-safebox-foreign-warp-coords-bundle.json` (`open_safebox` definition with illegal teleporter `map_index` / `x` / `y`), or `docs/examples/bootstrap-invalid-open-cube-foreign-warp-coords-bundle.json` (`open_cube` definition with illegal teleporter `map_index` / `x` / `y`), or `docs/examples/bootstrap-invalid-open-safebox-oversize-size-bundle.json` (`open_safebox` definition with authored page-count `size = 4` above `OpenSafeboxSizeMax = 3`), or `docs/examples/bootstrap-invalid-open-safebox-foreign-reward-gold-bundle.json` (`open_safebox` definition with illegal turn-in `reward_gold`), or `docs/examples/bootstrap-invalid-open-cube-foreign-reward-gold-bundle.json` (`open_cube` definition with illegal turn-in `reward_gold`), or `docs/examples/bootstrap-invalid-open-cube-foreign-reward-experience-bundle.json` (`open_cube` definition with illegal turn-in `reward_experience`), or `docs/examples/bootstrap-invalid-open-safebox-foreign-reward-experience-bundle.json` (`open_safebox` definition with illegal turn-in `reward_experience`), or `docs/examples/bootstrap-invalid-open-safebox-foreign-consume-gold-bundle.json` (`open_safebox` definition with illegal turn-in `consume_gold`), or `docs/examples/bootstrap-invalid-open-cube-foreign-consume-gold-bundle.json` (`open_cube` definition with illegal turn-in `consume_gold`), or `docs/examples/bootstrap-invalid-open-safebox-foreign-consume-experience-bundle.json` (`open_safebox` definition with illegal turn-in `consume_experience`), or `docs/examples/bootstrap-invalid-open-cube-foreign-consume-experience-bundle.json` (`open_cube` definition with illegal turn-in `consume_experience`), or `docs/examples/bootstrap-invalid-open-safebox-foreign-reward-items-bundle.json` (`open_safebox` definition with illegal turn-in `reward_items`), or `docs/examples/bootstrap-invalid-open-cube-foreign-reward-items-bundle.json` (`open_cube` definition with illegal turn-in `reward_items`), or `docs/examples/bootstrap-invalid-open-safebox-foreign-consume-items-bundle.json` (`open_safebox` definition with illegal turn-in `consume_items`), or `docs/examples/bootstrap-invalid-open-cube-foreign-consume-items-bundle.json` (`open_cube` definition with illegal turn-in `consume_items`), or `docs/examples/bootstrap-invalid-open-safebox-foreign-quest-to-bundle.json` (`open_safebox` definition with complete quest gate plus mutating `quest_to`), or `docs/examples/bootstrap-invalid-open-cube-foreign-quest-to-bundle.json` (`open_cube` definition with complete quest gate plus mutating `quest_to`), or `docs/examples/bootstrap-invalid-open-safebox-foreign-reward-item-vnum-bundle.json` (`open_safebox` definition with illegal scalar turn-in `reward_item_vnum` / `reward_item_count` shorthand), or `docs/examples/bootstrap-invalid-open-cube-foreign-reward-item-vnum-bundle.json` (`open_cube` definition with illegal scalar turn-in `reward_item_vnum` / `reward_item_count` shorthand), or `docs/examples/bootstrap-invalid-shop-preview-foreign-reward-item-vnum-bundle.json` (`shop_preview` definition with illegal scalar turn-in `reward_item_vnum` / `reward_item_count` shorthand beside an otherwise valid merchant catalog), or `docs/examples/bootstrap-invalid-info-embedded-nul-text-bundle.json` (`info` definition whose `text` contains JSON `\u0000`) and confirm each returns `400` / fail closed before import. Owned multi-count regen authoring follows `docs/plans/2026-08-23-multi-count-regen-pack-placement-contract-freeze.md`: live runtime still sees only independent one-actor `spawn_groups` after expansion.
...
- [ ] Approach a visible authored QA NPC with `info`, `talk`, `quest_flag`, merchant `shop_preview`, warehouse `open_safebox`, or craftsman `open_cube`
...
- [ ] If using `docs/examples/bootstrap-npc-service-bundle.json` or `docs/examples/bootstrap-pve-vertical-authoring-bundle.json`, confirm the QA teleporter is quest-gated on `quest:first_steps.met_guide = 1`: before meeting `QuestGuide`, interacting with `Teleporter` yields `Quest requirements are not met.` and no transfer; after the guide advances the flag, the same teleporter transfers normally without changing quest-state. The composed PvE vertical fixture's teleporter is a same-map warp to `470200,964200` with authored text `Step through the gate.` first, then the current transfer/rebootstrap burst; after that destination the player is outside the 300-unit interaction radius of the QA square and must walk back before merchant / mob / turn-in INTERACT
...
- [ ] If using that same QA bundle, after `QuestHunter` turn-in reopen the QA merchant and attempt packet `SHOP BUY` catalog slot `1` (`Wooden Sword` `11200` @ `500g`): confirm one self-only merchant-family `GC::SHOP NOT_ENOUGH_MONEY`, gold/inventory stay at the post-turn-in snapshot, and the window stays open. Then buy catalog slot `0` (`Small Red Potion` `27001` @ `50g`) and confirm one self-only `ITEM_SET` into the first free carried slot (slot `1` because the turn-in sword occupies slot `0`) with no extra `GC::SHOP OK`, gold debit by `50`, and reconnect/operator inspection matching that post-buy inventory. Keep that same window open and packet-`SHOP SELL` the bought potion from carried slot `1`: confirm self-only `ITEM_DEL` then `PLAYER_POINT_CHANGE(POINT_GOLD)` for authored `shop_sell_price = 2`, no extra `GC::SHOP OK`, gold credit by `2`, and inventory keeping only the turn-in sword. Then packet-buy catalog slot `0` again into slot `1` so the later last-stack `ITEM_USE` still has a potion. The composed PvE vertical gameplay proof (`TestPveVerticalAuthoringBundleClosesGuideUnlockKillCreditAndTurnIn`) now does this buy-then-sell-then-rebuy on the authoring-form import path before `QuestResetGuide`. Keep that same window open, then INTERACT `QuestResetGuide` (`quest:first_steps_reset`): confirm that INTERACT prepends one merchant-family `GC::SHOP END` before the authored clear chat `Quest cleared: first_steps.met_guide = 0.`, gold/inventory stay at the post-rebuy snapshot, a later packet `SHOP BUY` against the already-closed window is silent/no-frame, and gated merchant/talk INTERACT now mismatch until `QuestGuide` writes `met_guide = 1` again. After that closed window, packet `ITEM_USE` the bought `27001` last stack and confirm the owned last-stack burst (`ITEM_USE` echo, `PLAYER_POINT_CHANGE` `+50`, `ITEM_DEL`, info chat `consume:27001:+50`) plus reconnect/operator inspection of the HP/inventory change; then packet `ITEM_MOVE` the turn-in `11200` onto the weapon wear cell and confirm `ITEM_DEL` / equipment `ITEM_SET` / self `CHARACTER_UPDATE` with the sword worn. If clearing through `POST /local/quest-state/transition` instead, keep the merchant window open and confirm the next packet `SHOP BUY` / `SHOP SELL` / `SHOP SELL2` or `/shop_buy` auto-closes that stale window with one merchant-family `GC::SHOP END` and leaves gold/inventory unchanged until the merchant is opened again
...
- [ ] If using that same QA bundle, inspect `GET /local/interaction-visibility/{character}` and confirm the visible `CubeMaster` `open_cube` actor previews `Quest requirements are not met.` before meeting `QuestGuide`, then `The craftsman lights the forge. [open_cube]` after the guide advances the flag, without mutating quest-state. Operators can also inspect `GET /local/content-bundle/open-cube-routes/CubeMaster` or `GET /local/content-bundle/maps/1/open-cube-routes` for the authored race_num/gate placement without opening cube in-game. After the first unlocked warehouse close, the composed PvE vertical gameplay proof now also INTERACTs that CubeMaster and `/cube r_info` / `/cube r_info 0` before `/close_cube` and reconnect, with gold/inventory/quest-state unchanged
- [ ] If using `docs/examples/bootstrap-npc-service-bundle.json` or `docs/examples/bootstrap-pve-vertical-authoring-bundle.json`, confirm `VillageGuide` (`talk`) and `VillageSignpost` (`info`) are also quest-gated on `quest:first_steps.met_guide = 1`: before meeting `QuestGuide`, interacting with either yields `Quest requirements are not met.` and no authored chat text; after the guide advances the flag, both return their authored self-only chat deliveries without changing quest-state. The composed PvE vertical gameplay proof (`TestPveVerticalAuthoringBundleClosesGuideUnlockKillCreditAndTurnIn`) now INTERACTs those talk/info/warp actors on the same authoring-form import path as warehouse / cube / merchant / turn-in / `QuestResetGuide`
...
- [ ] If the authored QA merchant catalog exposes an affordable test item, attempt one packet `SHOP BUY` from the open window and confirm the success path returns self-only inventory refreshes without an extra merchant-family `GC::SHOP OK` or the older placeholder info chat; newly occupied slots should use `ITEM_SET`, while merges into already-known carried stacks should use `ITEM_UPDATE` that keeps destination presence-aware instance sockets/attributes authoritative (including explicit zero; omitted destination keeps template-fallback encode) rather than inventing merchant template sockets/attributes onto the destination (`docs/plans/2026-09-04-merchant-buy-compatible-merge-destination-wins-instance-sockets-attributes.md`). The composed PvE vertical gameplay proof now packet-buys `npc:qa_merchant` catalog slot `0` (`27001` @ `50g`) after `QuestHunter` turn-in, following one insufficient-gold slot-`1` reject, packet-sells that bought potion from carried slot `1` (`ITEM_DEL` + gold `POINT_CHANGE` for `2g`), packet-buys slot `0` again, then `QuestResetGuide`, then packet-uses that re-bought potion and packet-equips the turn-in `11200` after the merchant window closes. After `QuestGuide` re-unlock reopens the merchant, confirm `SHOP SELL` while the sword is still worn returns `GC::SHOP INVALID_POS` with no gold/equipment mutation; then packet-unequip onto carried slot `0` and `SHOP SELL` that last stack for authored `shop_sell_price = 100` (`ITEM_DEL` then `PLAYER_POINT_CHANGE(POINT_GOLD)`), with no extra `GC::SHOP OK`. The same composed proof now also warehouse-INTERACTs after that re-unlock (prepends `GC::SHOP END`, then `ShowMeSafeboxPassword`), opens with `/safebox_password 000000` (`SAFEBOX_SIZE` size `2` / rematerialized `SAFEBOX_MONEY_CHANGE` `60`), `/safebox_money_withdraw 60`, fail-closed `SAFEBOX_CHECKIN` while the sword is still worn, then unequip / checkin / checkout / sell
- [ ] If the QA setup allows it, sell one carried item stack from the open merchant window and confirm the success path returns a carried-slot refresh (`ITEM_DEL` for whole-stack removal or `ITEM_UPDATE` for partial-stack decrement) followed by `PLAYER_POINT_CHANGE(POINT_GOLD)`, with no extra bare merchant-family `GC::SHOP OK`. The composed PvE vertical gameplay proof now also whole-stack `SHOP SELL`s the just-bought `27001` potion from carried slot `1` on the post-turn-in QA merchant window, then later packet-unequips and packet-sells turn-in `11200` for authored `shop_sell_price = 100` after `QuestGuide` re-unlock
...
- [ ] If using `docs/examples/bootstrap-pve-vertical-authoring-bundle.json`, confirm the destination stays on map `1` at `470200,964200` (same-map warp, not a foreign-map hop) and walk back into the QA square's 300-unit interaction radius before continuing merchant / mob / turn-in smoke
...
- [ ] In a separate multi-step homeward run, chase-displace the practice mob more than one `max_step=100` from authored home (for example two chase beats to +200), leave aggro, clear with `TARGET(0)`, then wait through two owned `1s` homeward beats: confirm the first due homeward `MOVE` steps +100 toward home and keeps a pending homeward row, and the second due lands on authored home / `at_home` and clears the pending row
- [ ] In a separate chase-replan run, accept a hit that arms chase while still near authored home (for example owner at +100), then walk farther along the same axis before the owned `5s` chase deadline (for example to +200) while remaining inside combat-target range / leash / visibility: confirm engagement + the pending chase row stay armed, and the due retained-viewer chase `MOVE` steps toward the live post-move owner coords rather than the arm-time snapshot
...
- [ ] In a separate abrupt-disconnect homeward run, hit -> wait through delayed retaliation -> wait through chase displace so the mob is `within_radius`, then force an abrupt socket close / client disconnect (not `/quit` / `/logout` / `/phase_select`); confirm `GET /local/spawn-group-chase-steps/{entity_id}` clears, `GET /local/spawn-group-homeward-steps/{entity_id}` arms, and a living retained watcher receives one due homeward `MOVE` back to authored home after the owned `1s` homeward delay (matching the slash-leave / transfer / EnterGame-reclaim twins)
- [ ] In a separate proximity-armed homeward run (no selected combat target), walk inside aggro so proximity acquires and arms chase, wait through delayed retaliation then through chase displace so the mob is `within_radius`, then walk outside aggro without inventing `TARGET(0)`; confirm `GET /local/spawn-group-chase-steps/{entity_id}` clears, `GET /local/spawn-group-homeward-steps/{entity_id}` arms, and a living retained watcher receives one due homeward `MOVE` back to authored home after the owned `1s` homeward delay
...
- [ ] Contrast that with a hit-armed / still-selected practice mob: after an accepted hit arms chase, walk outside the default aggro radius while remaining inside combat-target range / leash / visibility and confirm engagement + the pending chase row stay armed (no proximity leave-radius release); only an explicit release such as client `TARGET(0)`, death floor, disconnect/transfer, return recovery, combat-range loss, or visibility loss should clear that hit-armed chase
- [ ] In a separate hit-armed chase-displace run, keep the practice mob selected after one due chase beat leaves it `within_radius`, then walk outside combat-target range (`300`) while remaining inside visibility and confirm one self-only `TARGET(0, 0)`, chase clear, within_radius homeward arm, and a later retained-viewer homeward `MOVE` back to authored home / `at_home`
- [ ] In a separate hit-armed chase-displace run, keep the practice mob selected after one due chase beat leaves it `within_radius`, then walk outside visibility of the displaced actor and confirm self `CHARACTER_DEL` plus `TARGET(0, 0)`, chase clear, within_radius homeward arm, and a later retained-viewer homeward `MOVE` back to authored home / `at_home`
...
Run this when the target build can import `docs/examples/bootstrap-combat-profile-formula-bundle.json`. That fixture owns one formula-first custom profile (`qa_formula_practice_mob`: `max_hp = 20`, `attack_value = 9`, `defense_value = 4`, `aggro_radius = 150`, `leash_radius = 350`, `chase_delay_ms = 2000`, `return_delay_ms = 2000`, `homeward_delay_ms = 2000`, `max_step = 50`, `reaction_delay_ms = 2000`, `retaliation_point_delta = -2`) bound to `practice.qa_formula_mob`, with profile-default EXP/gold/drop reward metadata.

- [ ] `POST /local/content-bundle/validate` the fixture and confirm the response derives `damage_per_normal_attack = 5`, defaults `level = 1`, preserves authored `aggro_radius = 150` / `leash_radius = 350` plus Track A timing fields (`chase_delay_ms` / `return_delay_ms` / `homeward_delay_ms` / `reaction_delay_ms` = `2000`, `max_step = 50`) and authored `retaliation_point_delta = -2`, and expands the spawn-group reward descriptor from the profile death reward
- [ ] Import the fixture, then confirm `GET /local/content-bundle/combat-profiles/qa_formula_practice_mob` and `GET /local/content-bundle/spawn-groups/practice.qa_formula_mob` expose the same formula/reward/radius/timing/retaliation defaults
...
- kill-quest credit is a separate spawn-group content seam from the EXP/gold/drop descriptor; the combined NPC service QA fixture now authors both, `docs/examples/bootstrap-pve-vertical-authoring-bundle.json` proves the same loop from authoring-form regen/drop input, `docs/examples/bootstrap-kill-quest-credit-bundle.json` remains the narrow direct credit-only example (runtime-import twin `TestGameRuntimeImportsKillQuestCreditExample`), `docs/examples/bootstrap-npc-service-bundle.json` remains the byte-canonical combined quest-loop fixture (runtime-import twin `TestGameRuntimeImportsNpcServiceExample`), and `docs/examples/bootstrap-kill-quest-only-drop-table-authoring-bundle.json` is the matching kill-quest-only `drop_tables` authoring form, and `docs/examples/bootstrap-kill-quest-only-regen-authoring-bundle.json` is the matching regen authoring form of that kill-quest-only table (see `quest-state-bootstrap.md`); both kill-quest-only fixtures are also covered by dedicated runtime-import proofs; `docs/examples/bootstrap-drop-table-authoring-bundle.json` and `docs/examples/bootstrap-regen-authoring-bundle.json` are the matching combat+kill-quest authoring fixtures and are also covered by dedicated runtime-import proofs (`TestGameRuntimeImportsDropTableAuthoringExample` / `TestGameRuntimeImportsRegenAuthoringExample`); `docs/examples/bootstrap-multi-count-regen-authoring-bundle.json` is the focused multi-count pack authoring twin (`count = 2`, `pack_spacing = 100` → independent `.m01` / `.m02` members with the same gated kill-quest credit) and is also covered by a dedicated runtime-import proof
...
- [ ] If a merchant window is open when the immediate or delayed retaliation beat reaches `0` HP, confirm one self-only `GC::SHOP END` follows the death/clear sequence and later `SHOP END` / `SHOP BUY` attempts fail closed until a fresh merchant interaction opens a new window; then after `/restart_here` a fresh `EXCHANGE START` against a living visible peer succeeds instead of returning the open-merchant busy reject; in a separate town-return run with a living destination-map peer already on the owned empire town map, confirm `/restart_town` likewise lets a fresh destination-peer `EXCHANGE START` succeed instead of the open-merchant busy reject (`TestGameSessionFlowPracticeMobImmediateRetaliationFloorClosesOpenMerchantBeforeRestartExchange`, `TestGameSessionFlowPracticeMobDelayedRetaliationFloorClosesOpenMerchantBeforeRestartExchange`, `TestGameSessionFlowPracticeMobImmediateRetaliationFloorClosesOpenMerchantBeforeRestartTownExchange`, `TestGameSessionFlowPracticeMobDelayedRetaliationFloorClosesOpenMerchantBeforeRestartTownExchange`)
- [ ] If an accepted host-only `MYSHOP` is open when the immediate or delayed retaliation beat reaches `0` HP, confirm one empty-sign `GC::SHOP_SIGN` follows the death/clear sequence (after any merchant `SHOP END`, before any lab `cube close` / safebox `CloseSafebox` or exchange close), currently visible peers receive the same empty-sign around-broadcast, later `/close_myshop` stays silent, inventory/gold stay unchanged, then after `/restart_here` a fresh `EXCHANGE START` against a living visible peer succeeds; in a separate town-return run with a living destination-map peer already on the owned empire town map, confirm `/restart_town` likewise lets a fresh destination-peer `EXCHANGE START` succeed instead of the open-private-shop busy reject (`TestGameSessionFlowPracticeMobImmediateRetaliationFloorClosesOpenMyShopBeforeRestartTownExchange`, `TestGameSessionFlowPracticeMobDelayedRetaliationFloorClosesOpenMyShopBeforeRestartTownExchange`)
- [ ] If a second living client was browsing that open MYSHOP when the host reached `0` HP through an immediate or delayed retaliation beat, confirm the guest receives one queued `GC::SHOP END` beside the empty-sign around-broadcast and later guest `SHOP END` / `ON_CLICK` stay silent
- [ ] If the dying client itself was browsing another peer's open MYSHOP when immediate or delayed retaliation reached `0` HP, confirm one self-only `GC::SHOP END` follows death/clear, browse clears without inventory/gold mutation, and later guest `SHOP END` / `ON_CLICK` stay silent
- [ ] If a bootstrap exchange window is open with a living visible peer when the immediate or delayed retaliation beat reaches `0` HP, confirm the dead owner receives one self-only `GC::EXCHANGE END` after the death/clear sequence, the paired peer receives one queued `GC::EXCHANGE END`, later stale `EXCHANGE CANCEL` / display requests fail closed, then after `/restart_here` a fresh `EXCHANGE START` against the same living visible peer succeeds with ordinary paired start frames instead of operating on a stale pairing; in a separate town-return run with a living destination-map peer already on the owned empire town map, confirm `/restart_town` likewise lets a fresh destination-peer `EXCHANGE START` succeed instead of a stale exchange pairing (`TestGameSessionFlowPracticeMobImmediateRetaliationFloorClosesOpenExchangeShellBeforeRestartExchange`, `TestGameSessionFlowPracticeMobDelayedRetaliationFloorClosesOpenExchangeShellBeforeRestartExchange`, `TestGameSessionFlowPracticeMobImmediateRetaliationFloorClosesOpenExchangeShellBeforeRestartTownExchange`, `TestGameSessionFlowPracticeMobDelayedRetaliationFloorClosesOpenExchangeShellBeforeRestartTownExchange`)
- [ ] If `/open_cube` was already open when the immediate or delayed retaliation beat reaches `0` HP, confirm one self-only `CHAT_TYPE_COMMAND` `cube close` follows the death/clear sequence (after any merchant `SHOP END` / MYSHOP empty-sign, before any safebox `CloseSafebox` or exchange close), later `/close_cube` stays silent, inventory/gold stay unchanged, then after `/restart_here` a fresh `EXCHANGE START` against a living visible peer succeeds; in a separate town-return run with a living destination-map peer already on the owned empire town map, confirm `/restart_town` likewise lets a fresh destination-peer `EXCHANGE START` succeed instead of the open-cube busy reject (`TestGameSessionFlowPracticeMobImmediateRetaliationFloorClosesOpenCubeBeforeRestartTownExchange`, `TestGameSessionFlowPracticeMobDelayedRetaliationFloorClosesOpenCubeBeforeRestartTownExchange`)
- [ ] If `/open_safebox` was already open when the immediate or delayed retaliation beat reaches `0` HP, confirm one self-only `CHAT_TYPE_COMMAND` `CloseSafebox` follows the death/clear sequence (after any merchant `SHOP END` / MYSHOP empty-sign / lab `cube close`, before any exchange close), later `/close_safebox` stays silent, then after `/restart_here` a fresh `EXCHANGE START` against a living visible peer succeeds instead of returning the open-safebox busy reject; in a separate town-return run with a living destination-map peer already on the owned empire town map, confirm `/restart_town` likewise lets a fresh destination-peer `EXCHANGE START` succeed instead of the open-safebox busy reject (`TestGameSessionFlowPracticeMobImmediateRetaliationFloorClosesOpenSafeboxBeforeRestartTownExchange`, `TestGameSessionFlowPracticeMobDelayedRetaliationFloorClosesOpenSafeboxBeforeRestartTownExchange`)
- [ ] If a refine-dialog preview was already open when the immediate or delayed retaliation beat reaches `0` HP, confirm the death/clear sequence stays free of extra refine frames, later `REFINE type = 255` cancel stays silent, then after `/restart_here` a fresh `EXCHANGE START` against a living visible peer succeeds instead of returning the open-refine busy reject; in a separate town-return run with a living destination-map peer already on the owned empire town map, confirm `/restart_town` likewise lets a fresh destination-peer `EXCHANGE START` succeed instead of the open-refine busy reject (`TestGameSessionFlowPracticeMobImmediateRetaliationFloorClosesOpenRefineBeforeRestartTownExchange`, `TestGameSessionFlowPracticeMobDelayedRetaliationFloorClosesOpenRefineBeforeRestartTownExchange`)
...
- [ ] Confirm post-floor storage attempts stay silent and non-mutating: no safebox/mall response frames, no `anti_safebox` info-chat feedback, no carried inventory/equipment/quickslot/point/gold changes, no ground handles, and no persistence update; after `/restart_here` / `/restart_town`, repeat the anti-safebox `SAFEBOX_CHECKIN` and confirm the ordinary self-only reject chat returns without inventory mutation (`TestGameSessionFlowPostFloorSafeboxCheckinFailsClosedBeforeAntiSafeboxFeedback`, `TestGameSessionFlowPostFloorSafeboxCheckinFailsClosedBeforeRestartTown`)
- [ ] While still at `0` HP and before `/restart_here`, try fresh busy-shell opens: `/open_safebox`, a pending warehouse `/safebox_password` after `ShowMeSafeboxPassword`, `/safebox_change_password 000000 vault2`, `/safebox_money_save 100`, `/safebox_money_withdraw 100`, `/open_cube`, host-only `CG::MYSHOP`, guest private-shop browse `CG::ON_CLICK` against a living peer's already-open `MYSHOP`, carried shop-bag / silk-bag `ITEM_USE` or `/use_item`, a refineable `REFINE` preview, and `EXCHANGE START` against a living visible peer; also have that living peer try `EXCHANGE START` against the dead owner
- [ ] Confirm those post-floor open / durable-password / warehouse-money / bag-USE attempts stay silent and non-mutating: no `SAFEBOX_SIZE` / change-password info chat / gold `PLAYER_POINT_CHANGE` / `SAFEBOX_MONEY_CHANGE` / `cube open` / `SHOP_SIGN` / guest `SHOP START` / `OpenPrivateShop` / `MyShopPriceList` / `REFINE_INFORMATION_NEW` / exchange start frames, no busy flags, no inventory/gold/durable-password/warehouse-money changes (`TestGameSessionFlowPostFloorOpenSafeboxFailsClosed`, `TestGameSessionFlowPostFloorOpenSafeboxFailsClosedBeforeRestartTown`, `TestGameSessionFlowPostFloorSafeboxPasswordOpenFailsClosed`, `TestGameSessionFlowPostFloorSafeboxPasswordOpenFailsClosedBeforeRestartTown`, `TestGameSessionFlowPostFloorSafeboxChangePasswordFailsClosed`, `TestGameSessionFlowPostFloorSafeboxChangePasswordFailsClosedBeforeRestartTown`, `TestGameSessionFlowPostFloorSafeboxMoneyFailsClosed`, `TestGameSessionFlowPostFloorSafeboxMoneyFailsClosedBeforeRestartTown`, `TestGameSessionFlowPostFloorOpenCubeFailsClosed`, `TestGameSessionFlowPostFloorOpenCubeFailsClosedBeforeRestartTown`, `TestGameSessionFlowPostFloorMyShopOpenFailsClosed`, `TestGameSessionFlowPostFloorMyShopOpenFailsClosedBeforeRestartTown`, `TestGameSessionFlowPostFloorMyShopGuestOnClickFailsClosed`, `TestGameSessionFlowPostFloorMyShopGuestOnClickFailsClosedBeforeRestartTown`, `TestGameSessionFlowPostFloorShopBagUseFailsClosed`, `TestGameSessionFlowPostFloorShopBagUseFailsClosedBeforeRestartTown`, `TestGameSessionFlowPostFloorSilkBagUseFailsClosed`, `TestGameSessionFlowPostFloorSilkBagUseFailsClosedBeforeRestartTown`, `TestGameSessionFlowPostFloorRefinePreviewOpenFailsClosed`, `TestGameSessionFlowPostFloorRefinePreviewOpenFailsClosedBeforeRestartTown`, `TestGameSessionFlowPostFloorExchangeStartFailsClosed`, `TestGameSessionFlowPostFloorExchangeStartFailsClosedBeforeRestartTown`, `TestGameSessionFlowPostFloorExchangeStartAgainstDeadPartnerFailsClosed`, `TestGameSessionFlowPostFloorExchangeStartAgainstDeadPartnerFailsClosedBeforeRestartTown`); after `/restart_here` / `/restart_town`, lab `/open_safebox` and `/open_cube` succeed normally again, host-only `MYSHOP` and guest browse `ON_CLICK` succeed normally again, refineable `REFINE` preview succeed normally again, shop/silk-bag USE emits `OpenPrivateShop` (plus first-session silk `MyShopPriceList`) without consuming the bag, fresh `EXCHANGE START` against a living visible peer succeeds with ordinary paired start frames, a living peer's fresh `EXCHANGE START` against the recovered former dead partner also succeeds with ordinary paired start frames, a stale pre-death `/safebox_password` still fails closed until a fresh warehouse interact re-arms the challenge, and `/safebox_change_password` plus (after fresh `/open_safebox`) `/safebox_money_*` succeed normally again
...
- [ ] After a combined last-hit that both kills the dummy and floors the owner, issue `/restart_here` before the owned respawn delay expires and confirm the recovery catch-up shows dummy delete-plus-add/info/update plus one trailing `GC DEAD(dummy_vid)`; a fresh `TARGET` should fail closed until the later ordinary live rebuild (`TestGameSessionFlowPracticeMobKillingHitAlsoFloorsOwnerRestartHereCatchesUpStillDeadDummy`)
- [ ] In a separate combined last-hit run, issue same-socket `/phase_select` → fresh `SELECT`/`ENTERGAME` before the dummy respawn delay expires and confirm still-dead re-entry rebuilds the owner floor without dummy add/info/update or dummy `DEAD`; then `/restart_here` should replay dummy delete-plus-add/info/update plus one trailing `GC DEAD(dummy_vid)`, keep `TARGET` / `ATTACK` fail-closed, and later live rebuild should allow a fresh full-HP `TARGET` (`TestGameSessionFlowPracticeMobKillingHitAlsoFloorsOwnerPhaseSelectRestartHereCatchesUpStillDeadDummy`)
- [ ] In another combined last-hit run, force an abrupt disconnect / reconnect before the dummy respawn delay expires and confirm the same still-dead owner bootstrap skips the dummy; then `/restart_here` should replay the same still-dead dummy catch-up (`TestGameSessionFlowPracticeMobKillingHitAlsoFloorsOwnerReconnectRestartHereCatchesUpStillDeadDummy`)
- [ ] In that same combined last-hit run when the dummy also drops an authored reward, confirm `/restart_here` rematerializes the pending ground handle with self-only `ITEM_GROUND_ADD` + `ITEM_OWNERSHIP` after the still-dead dummy catch-up, then ordinary `ITEM_PICKUP` succeeds while the dummy is still dead (`TestGameSessionFlowPracticeMobKillingHitAlsoFloorsOwnerRestartHereRematerializesKillRewardDrop`)
- [ ] In a separate combined last-hit reward run, issue `/restart_town` before the owned respawn delay expires and confirm the town burst tears down the source dummy plus pending drop (`CHARACTER_DEL` + `ITEM_GROUND_DEL`) without rematerializing them on the town map; after relocating back to the source map, confirm still-dead dummy trailing `GC DEAD` plus self-only `ITEM_GROUND_ADD` + `ITEM_OWNERSHIP`, then ordinary `ITEM_PICKUP` succeeds while the dummy is still dead (`TestGameSessionFlowPracticeMobKillingHitAlsoFloorsOwnerRestartTownRematerializesKillRewardDropOnSourceMapReselect`)
...
- [ ] In a separate daemon-restart schedule run, leave a live spawn-backed practice mob displaced `return_required` or unengaged `within_radius` (and optionally mid-chase while engaged), restart `gamed`, then confirm restore re-arms eligible return/homeward from **now** (not an absolute mid-timer due-at), chase stays unarmed until a fresh post-restart hit/proximity engagement, and engagement / selected-target ownership stay fail-closed across restart; automated coverage owns that composite posture via `TestGameRuntimeDaemonRestartRearmsReturnAndHomewardFromNowAndLeavesChaseUnarmed`
...
- `/restart_here` also preflights due mob respawn / return-step / chase-step / homeward-step timers and refreshes currently visible static actors plus pending ground handles for the recovered owner, so skipped zero-HP lifecycle frames do not leave stale local mob or kill-reward drop visuals
...
- post-floor `/equip_item` stays silent and non-mutating while at `0` HP; after `/restart_here` / `/restart_town` the same slash equip succeeds with the ordinary delete/set/point-change/appearance burst (`TestGameSessionFlowPostFloorEquipItemFailsClosed`, `TestGameSessionFlowPostFloorEquipItemFailsClosedBeforeRestartTown`)
- post-floor `/unequip_item` stays silent and non-mutating while at `0` HP; after `/restart_here` / `/restart_town` the same slash unequip succeeds with the ordinary delete/set/inverse-point-change/appearance burst (`TestGameSessionFlowPostFloorUnequipItemFailsClosed`, `TestGameSessionFlowPostFloorUnequipItemFailsClosedBeforeRestartTown`)
- post-floor `ITEM_DROP` stays silent and non-mutating while at `0` HP; after `/restart_here` / `/restart_town` the same whole-stack drop succeeds with ordinary `ITEM_DEL` + `GROUND_ADD` + `OWNERSHIP` and clears the carried slot (`TestGameSessionFlowPostFloorItemDropFailsClosed`, `TestGameSessionFlowPostFloorItemDropFailsClosedBeforeRestartTown`)
- post-floor counted `ITEM_DROP2` stays silent and non-mutating while at `0` HP; after `/restart_here` / `/restart_town` the same partial-stack drop succeeds with ordinary `ITEM_UPDATE` + `GROUND_ADD` + `OWNERSHIP`, preserves item/skill quickslots on the still-occupied cell, and registers one owned ground item for the dropped count (`TestGameSessionFlowPostFloorItemDrop2FailsClosed`, `TestGameSessionFlowPostFloorItemDrop2FailsClosedBeforeRestartTown`)
- post-floor gold `ITEM_DROP` stays silent and non-mutating while at `0` HP; after `/restart_here` / `/restart_town` the same gold drop succeeds with ordinary gold `PLAYER_POINT_CHANGE` + `GROUND_ADD` (`vnum = 1`) + `OWNERSHIP` and registers one owned gold marker (`TestGameSessionFlowPostFloorGoldDropFailsClosed`, `TestGameSessionFlowPostFloorGoldDropFailsClosedBeforeRestartTown`)
- post-floor `ITEM_PICKUP` stays silent and non-mutating while at `0` HP and leaves the pending ground handle registered; after `/restart_here` the same inventory-item pickup succeeds with ordinary `GROUND_DEL` + `ITEM_SET` + `ITEM_GET`, and after `/restart_town` a town-local drop then pickup succeeds at the empire town-return position (`TestGameSessionFlowPostFloorItemPickupFailsClosed`, `TestGameSessionFlowPostFloorItemPickupFailsClosedBeforeRestartTown`)
- post-floor gold `ITEM_PICKUP` stays silent and non-mutating while at `0` HP and leaves the pending gold marker registered; after `/restart_here` the same gold pickup succeeds with ordinary `GROUND_DEL` + gold `PLAYER_POINT_CHANGE` + `ITEM_GET`, and after `/restart_town` a town-local gold drop then pickup succeeds at the empire town-return position (`TestGameSessionFlowPostFloorGoldPickupFailsClosed`, `TestGameSessionFlowPostFloorGoldPickupFailsClosedBeforeRestartTown`)
- post-floor `QUICKSLOT_ADD` stays silent and non-mutating while at `0` HP; after `/restart_here` / `/restart_town` the same add succeeds with the ordinary self-only quickslot refresh and persists the new binding (`TestGameSessionFlowPostFloorQuickslotAddFailsClosed`, `TestGameSessionFlowPostFloorQuickslotAddFailsClosedBeforeRestartTown`)
- post-floor ordinary consumable `ITEM_USE` / `/use_item` stay silent and non-mutating while at `0` HP; after `/restart_here` / `/restart_town` the same `ITEM_USE` succeeds with the ordinary use-echo + point-change + stack refresh + info-chat burst and persists the stack decrement (`TestGameSessionFlowPostFloorItemUseFailsClosed`, `TestGameSessionFlowPostFloorItemUseFailsClosedBeforeRestartTown`)
- post-floor `ITEM_USE_TO_ITEM` stays silent and non-mutating while at `0` HP; after `/restart_here` / `/restart_town` the same full compatible stack merge succeeds with ordinary `ITEM_DEL` + `ITEM_UPDATE` + source item `QUICKSLOT_DEL`, persists the merged target stack, and leaves recovered MaxHP unchanged (`TestGameSessionFlowPostFloorItemUseToItemFailsClosed`, `TestGameSessionFlowPostFloorItemUseToItemFailsClosedBeforeRestartTown`)
- post-floor partial-stack `ITEM_USE_TO_ITEM` stays silent and non-mutating while at `0` HP; after `/restart_here` / `/restart_town` the same partial consolidation succeeds with ordinary source/target `ITEM_UPDATE` frames, preserves source/target item and skill quickslots on still-occupied cells, and persists the merged counts (`TestGameSessionFlowPostFloorItemUseToItemPartialFailsClosed`, `TestGameSessionFlowPostFloorItemUseToItemPartialFailsClosedBeforeRestartTown`)
- post-floor merchant `SHOP BUY` stays silent and non-mutating while at `0` HP after an open merchant was closed by the floor edge; after `/restart_here` / `/restart_town` recovery, a fresh merchant `INTERACT` past the owned static-actor cooldown reopens `GC::SHOP START` and the same catalog-slot `SHOP BUY` succeeds with ordinary inventory `ITEM_SET` and persists gold debit + bought stack (`TestGameSessionFlowPostFloorShopBuyFailsClosed`, `TestGameSessionFlowPostFloorShopBuyFailsClosedBeforeRestartTown`)
- post-floor whole-stack merchant `SHOP SELL` stays silent and non-mutating while at `0` HP after an open merchant was closed by the floor edge; after `/restart_here` / `/restart_town` recovery, a fresh merchant `INTERACT` past the owned static-actor cooldown reopens `GC::SHOP START` and the same `SHOP SELL` succeeds with ordinary `ITEM_DEL` + source item `QUICKSLOT_DEL` + gold `PLAYER_POINT_CHANGE` (`TestGameSessionFlowPostFloorShopSellFailsClosed`, `TestGameSessionFlowPostFloorShopSellFailsClosedBeforeRestartTown`)
- post-floor partial-stack merchant `SHOP SELL2` stays silent and non-mutating while at `0` HP after an open merchant was closed by the floor edge; after `/restart_here` / `/restart_town` recovery, a fresh merchant `INTERACT` past the owned static-actor cooldown reopens `GC::SHOP START` and the same `SHOP SELL2` succeeds with ordinary remaining-stack `ITEM_UPDATE` + gold `PLAYER_POINT_CHANGE` while keeping item/skill quickslots on the still-occupied cell (`TestGameSessionFlowPostFloorShopSell2FailsClosed`, `TestGameSessionFlowPostFloorShopSell2FailsClosedBeforeRestartTown`)
- post-floor non-refineable `REFINE` stays silent and non-mutating while at `0` HP; after `/restart_here` / `/restart_town` the same template-backed `REFINE` emits the ordinary self-only reject chat again without inventory mutation (`TestGameSessionFlowPostFloorItemRefineFailsClosedBeforeRejectFeedback`, `TestGameSessionFlowPostFloorItemRefineFailsClosedBeforeRestartTown`)
- post-floor refineable `probability = 100` `REFINE` preview/confirm stay silent and non-mutating while at `0` HP; after `/restart_here` / `/restart_town` recovery, the same preview emits ordinary `REFINE_INFORMATION_NEW` and the matching confirm succeeds with ordinary material `ITEM_DEL` + result `ITEM_SET` + gold `PLAYER_POINT_CHANGE` + `CHAT_TYPE_COMMAND` `RefineSuceeded <type>` (`TestGameSessionFlowPostFloorRefineConfirmSucceedsAfterRestartHere`, `TestGameSessionFlowPostFloorRefineConfirmSucceedsAfterRestartTown`)
- post-floor refineable `probability = 0` `REFINE` preview/confirm stay silent and non-mutating while at `0` HP; after `/restart_here` / `/restart_town` recovery, the same preview emits ordinary `REFINE_INFORMATION_NEW` and the matching confirm destroys with ordinary material `ITEM_DEL` + material `QUICKSLOT_DEL` + source `ITEM_DEL` + source `QUICKSLOT_DEL` + gold `PLAYER_POINT_CHANGE` + `CHAT_TYPE_COMMAND` `RefineFailed <type>` (`TestGameSessionFlowPostFloorRefineConfirmDestroySucceedsAfterRestartHere`, `TestGameSessionFlowPostFloorRefineConfirmDestroySucceedsAfterRestartTown`)
- post-floor refineable `probability` in `1..99` + `keep_on_fail` `REFINE` preview/confirm stay silent and non-mutating while at `0` HP; after `/restart_here` / `/restart_town` recovery, the same preview emits ordinary `REFINE_INFORMATION_NEW` and an injected failing roll confirm keeps the source with ordinary material `ITEM_DEL` + material `QUICKSLOT_DEL` + gold `PLAYER_POINT_CHANGE` + `CHAT_TYPE_COMMAND` `RefineFailed <type>` while retaining the source item quickslot (`TestGameSessionFlowPostFloorRefineConfirmKeepOnFailSucceedsAfterRestartHere`, `TestGameSessionFlowPostFloorRefineConfirmKeepOnFailSucceedsAfterRestartTown`)
- post-floor refineable `probability` in `1..99` + authored `fail_result_vnum` `REFINE` preview/confirm stay silent and non-mutating while at `0` HP; after `/restart_here` / `/restart_town` recovery, the same preview emits ordinary `REFINE_INFORMATION_NEW` and an injected failing roll confirm downgrades the source with ordinary material `ITEM_DEL` + material `QUICKSLOT_DEL` + source-cell `ITEM_SET(fail_result_vnum)` + gold `PLAYER_POINT_CHANGE` + `CHAT_TYPE_COMMAND` `RefineFailed <type>` while retaining the source item quickslot (`TestGameSessionFlowPostFloorRefineConfirmFailResultVnumSucceedsAfterRestartHere`, `TestGameSessionFlowPostFloorRefineConfirmFailResultVnumSucceedsAfterRestartTown`)
- post-floor refineable `probability` in `1..99` injected-success `REFINE` preview/confirm stay silent and non-mutating while at `0` HP; after `/restart_here` / `/restart_town` recovery, the same preview emits ordinary `REFINE_INFORMATION_NEW` and an injected succeeding roll confirm upgrades the source with ordinary material `ITEM_DEL` + material `QUICKSLOT_DEL` + source-cell `ITEM_SET(result_vnum)` + gold `PLAYER_POINT_CHANGE` + `CHAT_TYPE_COMMAND` `RefineSuceeded <type>` while retaining the source item quickslot (`TestGameSessionFlowPostFloorRefineConfirmInjectedSuccessSucceedsAfterRestartHere`, `TestGameSessionFlowPostFloorRefineConfirmInjectedSuccessSucceedsAfterRestartTown`)
- post-floor refineable `probability` in `1..99` injected-fail destroy `REFINE` preview/confirm stay silent and non-mutating while at `0` HP; after `/restart_here` / `/restart_town` recovery, the same preview emits ordinary `REFINE_INFORMATION_NEW` and an injected failing roll confirm destroys with ordinary material `ITEM_DEL` + material `QUICKSLOT_DEL` + source `ITEM_DEL` + source `QUICKSLOT_DEL` + gold `PLAYER_POINT_CHANGE` + `CHAT_TYPE_COMMAND` `RefineFailed <type>` while retaining the unrelated skill quickslot (`TestGameSessionFlowPostFloorRefineConfirmInjectedFailDestroySucceedsAfterRestartHere`, `TestGameSessionFlowPostFloorRefineConfirmInjectedFailDestroySucceedsAfterRestartTown`)
- post-floor ordinary carried-stack `SAFEBOX_CHECKIN` stays silent and non-mutating while at `0` HP; after `/restart_here` / `/restart_town` recovery, fresh `/open_safebox` opens an empty presentation and the same `SAFEBOX_CHECKIN` succeeds with ordinary `ITEM_DEL` + `SAFEBOX_SET` (`TestGameSessionFlowPostFloorSafeboxCheckinSucceedsAfterRestartHere`, `TestGameSessionFlowPostFloorSafeboxCheckinSucceedsAfterRestartTown`)
- post-floor whole-stack `SAFEBOX_ITEM_MOVE` stays silent and non-mutating while at `0` HP after an open safebox was closed by the floor edge; after `/restart_here` / `/restart_town` recovery, fresh `/open_safebox` rematerializes the remembered cell and the same `SAFEBOX_ITEM_MOVE` succeeds with ordinary `SAFEBOX_DEL` + destination `SAFEBOX_SET` (`TestGameSessionFlowPostFloorSafeboxItemMoveFailsClosed`, `TestGameSessionFlowPostFloorSafeboxItemMoveFailsClosedBeforeRestartTown`)
- post-floor partial-count `SAFEBOX_ITEM_MOVE` stays silent and non-mutating while at `0` HP after an open safebox was closed by the floor edge; after `/restart_here` / `/restart_town` recovery, fresh `/open_safebox` rematerializes the remembered multi-count cell and the same partial `SAFEBOX_ITEM_MOVE` succeeds with ordinary dual `SAFEBOX_SET` (source remainder + destination split) (`TestGameSessionFlowPostFloorSafeboxItemMovePartialSplitFailsClosed`, `TestGameSessionFlowPostFloorSafeboxItemMovePartialSplitFailsClosedBeforeRestartTown`)
- post-floor compatible partial-merge `SAFEBOX_ITEM_MOVE` stays silent and non-mutating while at `0` HP after an open safebox was closed by the floor edge; after `/restart_here` / `/restart_town` recovery, fresh `/open_safebox` rematerializes both remembered same-`vnum` cells and the same partial `SAFEBOX_ITEM_MOVE` succeeds with ordinary dual `SAFEBOX_SET` (source remainder + merged destination) (`TestGameSessionFlowPostFloorSafeboxItemMovePartialMergeFailsClosed`, `TestGameSessionFlowPostFloorSafeboxItemMovePartialMergeFailsClosedBeforeRestartTown`)
- post-floor whole-stack compatible-merge `SAFEBOX_ITEM_MOVE` stays silent and non-mutating while at `0` HP after an open safebox was closed by the floor edge; after `/restart_here` / `/restart_town` recovery, fresh `/open_safebox` rematerializes both remembered same-`vnum` cells and the same whole-stack `SAFEBOX_ITEM_MOVE` (`count = 0`) succeeds with ordinary `SAFEBOX_DEL` + merged destination `SAFEBOX_SET` (`TestGameSessionFlowPostFloorSafeboxItemMoveWholeMergeFailsClosed`, `TestGameSessionFlowPostFloorSafeboxItemMoveWholeMergeFailsClosedBeforeRestartTown`)
- post-floor `SAFEBOX_CHECKOUT` stays silent and non-mutating while at `0` HP after an open safebox was closed by the floor edge; after `/restart_here` / `/restart_town` recovery, fresh `/open_safebox` rematerializes the remembered cell and the same `SAFEBOX_CHECKOUT` succeeds with ordinary `SAFEBOX_DEL` + inventory `ITEM_SET` (`TestGameSessionFlowPostFloorSafeboxCheckoutFailsClosed`, `TestGameSessionFlowPostFloorSafeboxCheckoutFailsClosedBeforeRestartTown`)
- post-floor anti-safebox `SAFEBOX_CHECKIN` stays silent and non-mutating while at `0` HP; after `/restart_here` / `/restart_town` the same template-backed `SAFEBOX_CHECKIN` emits the ordinary self-only reject chat again without inventory mutation (`TestGameSessionFlowPostFloorSafeboxCheckinFailsClosedBeforeAntiSafeboxFeedback`, `TestGameSessionFlowPostFloorSafeboxCheckinFailsClosedBeforeRestartTown`)
- post-floor owner-side peer-facing `CHAT` / `WHISPER` and self-only `CHAT_TYPE_INFO` stay silent while at `0` HP; after `/restart_here` / `/restart_town` the same talking chat emits ordinary self echo plus queued peer delivery, the same whisper queues one exact-name target delivery, and the same info chat emits one self-only delivery again (`TestGameSessionFlowPostFloorPeerFacingChatFailsClosed`, `TestGameSessionFlowPostFloorPeerFacingChatFailsClosedBeforeRestartTown`)
...
- [ ] In a combined last-hit reward run, confirm `/restart_town` also tears down the pending source-map kill-reward drop with `ITEM_GROUND_DEL` without rematerializing it on the town map, then after relocating back to the source map confirm still-dead dummy trailing `GC DEAD` plus self-only `ITEM_GROUND_ADD` + `ITEM_OWNERSHIP` and ordinary `ITEM_PICKUP` while the dummy is still dead (`TestGameSessionFlowPracticeMobKillingHitAlsoFloorsOwnerRestartTownRematerializesKillRewardDropOnSourceMapReselect`)
...
- [ ] Confirm the selected session receives self-only refreshes for both slots: source stack remains in `A` with the reduced count and the split stack appears in `B`; when the source stack carries presence-aware instance sockets/attributes, confirm both `ITEM_SET` frames keep that presence (including explicit zero), the destination identity is fresh/independent, and the source remainder also keeps an independent clone of source presence rather than aliasing the pre-split live inventory pointer (`docs/plans/2026-09-06-item-move-partial-split-remainder-preserve-instance-sockets-attributes.md`)
- [ ] Reset to two compatible carried stacks, then send a partial-count `ITEM_MOVE` from `A` into occupied compatible stack slot `C`
- [ ] Confirm the selected session receives self-only `ITEM_UPDATE` refreshes for both slots: source stack remains in `A` with the reduced count and destination stack `C` grows by the moved count; if those stacks carry presence-aware instance sockets/attributes that differ from the loaded template and from each other, confirm the source remainder keeps source presence (including explicit zero) and the destination keeps destination presence rather than copying template display arrays, while omitted presence keeps template-fallback encode
...
- empty-destination partial splits plus compatible occupied-destination partial, exact, and zero-count merges are accepted and persisted; partial empty-destination splits mint a fresh destination identity and clone presence-aware instance sockets/attributes independently of the source remainder while the source remainder also keeps an independent clone of source presence (`docs/plans/2026-09-06-item-move-partial-split-remainder-preserve-instance-sockets-attributes.md`); compatible partial merges keep an independent source-remainder presence clone while destination presence wins on the merged cell; full-stack incompatible occupied destinations swap and persist instead of failing closed
...
- [ ] If the owning character is already at `1` HP for that same final dummy hit, confirm the burst keeps dummy death first (`DEAD(target_vid)` → `TARGET(0, 0)` → dummy `DAMAGE_INFO`) and then appends the owner-floor suffix (`PLAYER_POINT_CHANGE(value=0)` → `DEAD(owner_vid)` → `TARGET(0, 0)` → owner `DAMAGE_INFO`) instead of dropping the owner-floor half
- [ ] If a second visible selected session is present, confirm it also receives `GC DEAD(vid)`, its own self-only `GC TARGET(0, 0)` clear, and the same plain `GC DAMAGE_INFO(target_vid, damage)` companion during that same death window; if that same hit also floors the owner, confirm the watcher then also receives owner `DEAD(owner_vid)` plus owner `DAMAGE_INFO`
...
- [ ] Before the owned `2s` dead timer expires, bring in one fresh live session (or move/re-enter one back into visibility) and confirm it receives the ordinary dummy `CHARACTER_ADD` -> `CHAR_ADDITIONAL_INFO` -> `CHARACTER_UPDATE` burst immediately followed by one `GC DEAD(vid)` replay instead of a silently live-looking mob; that dummy `CHARACTER_ADD` uses type `0` (`CHAR_TYPE_MONSTER`) rather than the ordinary NPC type `1`
...
- [ ] Confirm the mob appears at the authored position with the authored display name, inserts as `CHARACTER_ADD.type = 0` (`CHAR_TYPE_MONSTER`) rather than ordinary NPC type `1`, and can be targeted in the same way as the earlier bootstrap dummy slices
...
- [ ] Lower the owning character's HP near `0` if you can, then confirm the immediate or delayed retaliation tick clamps at `0` HP instead of going negative, that a delayed or proximity-armed floor beat emits self `PLAYER_POINT_CHANGE(value=0)` → `DEAD(owner_vid)` → `TARGET(0, 0)` → `DAMAGE_INFO(owner_vid, abs(delta))`, that an accepted immediate owner-floor hit inserts one extra self plus visible-peer `DAMAGE_INFO(target_vid, applied_bootstrap_damage)` after that clear and before the owner companion, that a visible live peer receives `DEAD(owner_vid)` then that same owner `DAMAGE_INFO` (plus the matching mob companion on the accepted immediate hit), and that no further delayed follow-up beat arrives once that floor is reached
- [ ] If one accepted last hit both kills the dummy and floors the owner, confirm dummy death still owns the first prefix and the owner-floor suffix follows in the same packet burst (`TestGameSessionFlowPracticeMobKillingHitAlsoFloorsOwnerEmitsCombinedDeathBurst`). If that dummy also carries authored EXP / gold / drop rewards, confirm those reward frames stay after dummy death/clear/hit-effect and before the owner-floor suffix, that a visible live peer sees dummy death then the ground-add / ownership pair then owner death, and that the killer still persists EXP/gold plus HP `0` (`TestGameSessionFlowPracticeMobKillingHitAlsoFloorsOwnerEmitsRewardsBeforeOwnerFloor`)
- [ ] After that same combined last-hit, issue same-socket `/restart_here` before the dummy respawn delay expires and confirm the recovered owner sees dummy delete-plus-add/info/update plus one trailing `GC DEAD(dummy_vid)` rather than a live dummy; confirm a fresh `TARGET` / `ATTACK` still fail closed, then wait for the owned respawn rebuild and confirm a later fresh `TARGET` succeeds at full HP (`TestGameSessionFlowPracticeMobKillingHitAlsoFloorsOwnerRestartHereCatchesUpStillDeadDummy`)
- [ ] After that same combined last-hit, use same-socket `/phase_select` → fresh `SELECT`/`ENTERGAME` before the dummy respawn delay expires and confirm still-dead re-entry rebuilds the owner floor without dummy add/info/update or dummy `DEAD`; then `/restart_here` should replay dummy delete-plus-add/info/update plus one trailing `GC DEAD(dummy_vid)`, keep `TARGET` / `ATTACK` fail-closed, and later live rebuild should allow a fresh full-HP `TARGET` (`TestGameSessionFlowPracticeMobKillingHitAlsoFloorsOwnerPhaseSelectRestartHereCatchesUpStillDeadDummy`)
- [ ] After that same combined last-hit, force an abrupt disconnect / reconnect before the dummy respawn delay expires and confirm still-dead `ENTERGAME` also skips the dummy; then `/restart_here` should replay the same still-dead dummy catch-up (`TestGameSessionFlowPracticeMobKillingHitAlsoFloorsOwnerReconnectRestartHereCatchesUpStillDeadDummy`)
- [ ] In that same combined last-hit reward run, confirm `/restart_here` also rematerializes the pending kill-reward drop with self-only `ITEM_GROUND_ADD` + `ITEM_OWNERSHIP` after the still-dead dummy catch-up, then ordinary owner `ITEM_PICKUP` succeeds while the dummy is still dead (`TestGameSessionFlowPracticeMobKillingHitAlsoFloorsOwnerRestartHereRematerializesKillRewardDrop`)
- [ ] In a separate combined last-hit reward run, confirm `/restart_town` tears the source dummy and pending drop down from town visibility, rematerializes still-dead dummy trailing `GC DEAD` plus `ITEM_GROUND_ADD` + `ITEM_OWNERSHIP` after source-map relocate-back, then ordinary owner `ITEM_PICKUP` succeeds while the dummy is still dead (`TestGameSessionFlowPracticeMobKillingHitAlsoFloorsOwnerRestartTownRematerializesKillRewardDropOnSourceMapReselect`)
...
- [ ] Immediately after `/restart_here`, try one same-target normal `ATTACK` without reselecting and confirm it still fails closed on the live socket with no response frame; then send a fresh `TARGET` and confirm the same still-live practice mob resumes from its current runtime-owned HP instead of resetting because of the owner's recovery; after that fresh `TARGET`, send one normal `ATTACK` and confirm the usual target-refresh plus immediate self-only retaliation / `DAMAGE_INFO` companions resume (`TestGameSessionFlowPracticeMobRestartHereFreshTargetResumesNormalAttack`)
- [ ] After retaliation has already driven the owning character to `0` HP, force an abrupt disconnect / reconnect so still-dead `ENTERGAME` rebuilds the persisted floor, then send `/restart_here`; immediately afterward, confirm stale same-target `ATTACK` fails closed, a fresh `TARGET` preserves the still-live practice mob at its current runtime-owned HP, and the next normal `ATTACK` resumes with the usual target-refresh plus immediate self-only retaliation / `DAMAGE_INFO` companions for a still-visible peer (`TestGameSessionFlowPracticeMobReconnectRestartHereFreshTargetResumesNormalAttack`)
- [ ] After retaliation has already driven the owning character to `0` HP, use same-socket `/phase_select` → fresh `SELECT`/`ENTERGAME` so still-dead re-entry rebuilds the persisted floor, then send `/restart_here`; immediately afterward, confirm stale same-target `ATTACK` fails closed, a fresh `TARGET` preserves the still-live practice mob at its current runtime-owned HP, and the next normal `ATTACK` resumes with the usual target-refresh plus immediate self-only retaliation / `DAMAGE_INFO` companions for a still-visible peer (`TestGameSessionFlowPracticeMobPhaseSelectRestartHereFreshTargetResumesNormalAttack`)
...
- [ ] After `/restart_town`, relocate/return the recovered owner into source-map visibility of that same still-live practice mob, send a fresh owner-side `TARGET`, and confirm the ack preserves the current runtime-owned HP; then send one normal `ATTACK` and confirm the usual target-refresh plus immediate self-only retaliation / `DAMAGE_INFO` companions resume for a still-visible source-map peer (`TestGameSessionFlowPracticeMobRestartTownSourceMapReselectResumesNormalAttack`)
- [ ] After `/restart_town` reveals a destination-map practice mob, send a fresh town-side `TARGET` and then one normal `ATTACK`; confirm the destination mob moves from full HP to the next HP step with the usual target-refresh plus immediate self-only retaliation / `DAMAGE_INFO` companions, including matching peer `DAMAGE_INFO` for a still-visible destination town peer (`TestGameSessionFlowPracticeMobRestartTownDestinationFreshTargetResumesNormalAttack`)
- [ ] After retaliation has already driven the owning character to `0` HP, force an abrupt disconnect / reconnect so still-dead `ENTERGAME` rebuilds the persisted floor, then send `/restart_town`; immediately afterward, confirm stale source-map `ATTACK` fails closed, a fresh destination-map `TARGET` starts at full HP, and the next normal `ATTACK` resumes with the usual target-refresh plus immediate self-only retaliation / `DAMAGE_INFO` companions for a still-visible destination town peer (`TestGameSessionFlowPracticeMobReconnectRestartTownDestinationFreshTargetResumesNormalAttack`)
- [ ] After retaliation has already driven the owning character to `0` HP, use same-socket `/phase_select` → fresh `SELECT`/`ENTERGAME` so still-dead re-entry rebuilds the persisted floor, then send `/restart_town`; immediately afterward, confirm stale source-map `ATTACK` fails closed, a fresh destination-map `TARGET` starts at full HP, and the next normal `ATTACK` resumes with the usual target-refresh plus immediate self-only retaliation / `DAMAGE_INFO` companions for a still-visible destination town peer (`TestGameSessionFlowPracticeMobPhaseSelectRestartTownDestinationFreshTargetResumesNormalAttack`)
- [ ] After that same abrupt disconnect / reconnect still-dead `ENTERGAME` + `/restart_town` path, relocate/return the recovered owner into source-map visibility of the still-live damaged practice mob, send a fresh owner-side `TARGET`, and confirm the ack preserves the current runtime-owned HP; then send one normal `ATTACK` and confirm the usual target-refresh plus immediate self-only retaliation / `DAMAGE_INFO` companions resume for a still-visible source-map peer (`TestGameSessionFlowPracticeMobReconnectRestartTownSourceMapReselectResumesNormalAttack`)
- [ ] After that same `/phase_select` still-dead re-entry + `/restart_town` path, relocate/return the recovered owner into source-map visibility of the still-live damaged practice mob, send a fresh owner-side `TARGET`, and confirm the ack preserves the current runtime-owned HP; then send one normal `ATTACK` and confirm the usual target-refresh plus immediate self-only retaliation / `DAMAGE_INFO` companions resume for a still-visible source-map peer (`TestGameSessionFlowPracticeMobPhaseSelectRestartTownSourceMapReselectResumesNormalAttack`)
...
- [ ] After retaliation has already driven the owning character to `0` HP, send one accepted-position `CHARACTER_POSITION` stance request and confirm it now fails closed with no self `GC CHARACTER_POSITION`, no queued peer stance frame, no selected-target rewrite, no target HP mutation, and no normal-attack cadence/retaliation change; after `/restart_here` / `/restart_town`, repeat the same ground-sit `CHARACTER_POSITION` and confirm ordinary self presentation plus one queued peer stance frame succeed again (`TestGameSessionFlowPostFloorCharacterPositionFailsClosed`, `TestGameSessionFlowPostFloorCharacterPositionFailsClosedBeforeRestartTown`)
- [ ] After retaliation has already driven the owning character to `0` HP, send a `MOVE` toward a different visible coordinate (or a known transfer-trigger coordinate if one is configured) and confirm it fails closed with no self `MOVE_ACK`, no peer movement replication, and no transfer / rebootstrap burst; after `/restart_here` / `/restart_town`, repeat a same-map `MOVE` and confirm ordinary self `MOVE_ACK` succeeds again (`TestGameSessionFlowPostFloorMoveFailsClosed`, `TestGameSessionFlowPostFloorMoveFailsClosedBeforeRestartTown`)
- [ ] After retaliation has already driven the owning character to `0` HP, send a `SYNC_POSITION` update for that same character and confirm it fails closed with no self `SYNC_POSITION_ACK` and no peer synchronization replication; after `/restart_here` / `/restart_town`, repeat a same-map `SYNC_POSITION` and confirm ordinary self `SYNC_POSITION_ACK` succeeds again (`TestGameSessionFlowPostFloorSyncPositionFailsClosed`, `TestGameSessionFlowPostFloorSyncPositionFailsClosedBeforeRestartTown`)
- [ ] After retaliation has already driven the owning character to `0` HP, try one visible authored static-actor `INTERACT` request (`info`, `talk`, `shop_preview`, or `warp`) and confirm it fails closed with no self chat/info delivery, no merchant preview open, and no transfer / rebootstrap burst; after `/restart_here` / `/restart_town`, repeat a talk `INTERACT` past the owned static-actor cooldown and confirm ordinary self-only talk chat delivery succeeds again (`TestGameSessionFlowPostFloorInteractFailsClosed`, `TestGameSessionFlowPostFloorInteractFailsClosedBeforeRestartTown`)
...
- [ ] After retaliation has already driven the owning character to `0` HP, send one peer-facing `CHAT` with each owned type (`TALKING`, `PARTY`, `GUILD`, `SHOUT`) and confirm every request fails closed with no self `GC_CHAT` echo and no queued peer delivery; after `/restart_here` / `/restart_town`, confirm talking chat succeeds again with ordinary self echo plus queued peer delivery (`TestGameSessionFlowPostFloorPeerFacingChatFailsClosed`, `TestGameSessionFlowPostFloorPeerFacingChatFailsClosedBeforeRestartTown`)
- [ ] If you have a packet harness or test-client path that can still send client-originated `CHAT_TYPE_INFO`, try one after retaliation has already driven the owning character to `0` HP and confirm it fails closed with no self `GC_CHAT` info delivery; after `/restart_here` / `/restart_town`, confirm the same info chat emits one self-only delivery again
...
- [ ] After retaliation has already driven the owning character to `0` HP, send one `WHISPER` to a live visible peer and one to a missing exact-name target; confirm both fail closed with no queued target delivery and no self `WHISPER_TYPE_NOT_EXIST` fallback; after `/restart_here` / `/restart_town`, confirm the same live-peer whisper queues one exact-name target delivery again (`TestGameSessionFlowPostFloorPeerFacingChatFailsClosed`, `TestGameSessionFlowPostFloorPeerFacingChatFailsClosedBeforeRestartTown`)
...
- once retaliation has already driven the owning character to `0` HP, later owner-side combat `TARGET` / `ATTACK`, owner `MOVE` / `SYNC_POSITION`, owner static-actor `INTERACT`, owner merchant-buy, owner slash `/use_item`, owner slash `/inventory_move`, owner slash `/equip_item` / `/unequip_item`, owner peer-facing `CHAT` / `WHISPER`, and owner self-only `CHAT_TYPE_INFO` attempts fail closed too, while `/quit`, `/logout`, and `/phase_select` keep their current separate command behavior; after `/restart_here` / `/restart_town` the same owner-side talking chat / whisper / info chat succeed normally again (`TestGameSessionFlowPostFloorPeerFacingChatFailsClosed`, `TestGameSessionFlowPostFloorPeerFacingChatFailsClosedBeforeRestartTown`), and the same owner-side talk `INTERACT` likewise succeeds again (`TestGameSessionFlowPostFloorInteractFailsClosed`, `TestGameSessionFlowPostFloorInteractFailsClosedBeforeRestartTown`)
...
- do **not** treat the owned bootstrap quest loop as out of scope: when QA content is loaded, `quest_flag` unlock/turn-in, gated `info` / `talk` / `warp` / `shop_preview` / `open_safebox` / `open_cube`, kill-quest credit, and turn-in gold/experience/item consume+grant feedback are expected pass/fail checks (see §5.4 / §5.11)
...
- [ ] reconnect works
- [ ] when authored QA NPC content is loaded, supported NPC smoke checks (`info` / `talk`, `quest_flag`, `shop_preview`, `warp`, `open_safebox`, `open_cube`) pass without disconnecting the client
