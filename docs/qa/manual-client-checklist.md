...
- this is still not a completed refine system: catalysts, failure/destroy outcomes (including `CHAT_TYPE_COMMAND` `RefineFailed <type>`), and broader window choreography remain deferred beyond the confirm-after-preview success seam
