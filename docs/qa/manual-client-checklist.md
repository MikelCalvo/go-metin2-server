...
- [ ] Confirm closed-cube / unmatched / insufficient-gold / inventory-full `/cube make` stay fail-closed without mutation; `/cube make all` stays silent
