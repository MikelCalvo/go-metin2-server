...
- Durable safebox FileStore cells rematerialize the same presence-aware instance sockets across check-in → `gamed` restart → reopen / checkout (`TestGameRuntimeSafeboxCheckinInstanceSocketsRematerializeAcrossDaemonRestart`); tip-`0015` SQL additive stays deferred.
