...
- deferred next: `EXCHANGE START` gold-carrier-cap reject chat when either side already holds `>= 1<<31-1` gold (`You have more than 2 Billion Yang. You cannot trade.` / `The player has more than 2 Billion Yang. You cannot trade with him.`; `docs/plans/2026-08-22-exchange-start-gold-carrier-cap-reject-chat.md`)
