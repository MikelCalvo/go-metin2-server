...
- this is still not a completed refine system: catalysts, RNG/`1..99` outcomes, keep-grade/downgrade failure variants, and broader window choreography remain deferred beyond the confirm-after-preview success seam and the deterministic `probability = 0` destroy + `RefineFailed` companion
