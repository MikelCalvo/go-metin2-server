...
4. Track E item 1 historically listed quarantine/preflight through
   `0002`/`0003`/`0004`/`0007`/`0008`/`0009`/`0010`/`0011`/`0012`/`0013`; the
   later `0014` safebox tip sync widens that inventory (see
...
- ~~durable safebox persistence / password load~~ Done for FileStore
  rematerialize + backup/restore + `0014` export/quarantine: see
  [character safebox-state migration export seam](2026-08-23-character-safebox-state-migration-export-seam.md)
...
2. ~~Keep durable safebox persistence / password load deferred (items-lane
   contract freeze may land first).~~ Done for FileStore rematerialize +
   backup/restore + `0014` export/quarantine: see
   [ops docs 0014 safebox quarantine tip sync](2026-08-23-ops-docs-0014-safebox-quarantine-tip-sync.md).
   Money / mall / SQL import remain deferred.
