...
2. Continue JSON-file-store import/quarantine tooling beyond the landed `0002`/`0003`/`0004`/`0007`/`0008`/`0009`/`0010`/`0011`/`0012`/`0013`/`0014` quarantine preflights so optional offline ledger snapshots and any future migration-shaped exports can be validated without silently coercing bad snapshots. Offline ledger-snapshot inspection is now covered by `metin2-migrate ledger-snapshot-status`; offline `quarantine-export --kind character-safebox-state` closes the `0014` runbook gap beside the loopback surface.
