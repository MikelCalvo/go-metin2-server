...
3. Next items-lane seam after in-memory check-in/out: keep move / money / password / durable persistence deferred, or optionally harden merchant-window auto-close on accepted check-in/out success.
