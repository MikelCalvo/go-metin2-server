...
5. Read-only `backup-tree-status` for retained backup-restore trees is frozen next — see [CLI backup-tree-status contract freeze](2026-09-06-cli-backup-tree-status-contract-freeze.md). GREEN is follow-on.
