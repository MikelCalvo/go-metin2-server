...
1. Add matching hermetic seams for static-content exports once callers need the same coupling reduction. Login-ticket handoff and item-template state now have their own exporters + hermetic `MemoryStore`s.
