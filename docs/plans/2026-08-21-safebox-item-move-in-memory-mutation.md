...
1. ~~Close active merchant windows on accepted check-in / check-out / item-move success (`docs/plans/2026-08-21-safebox-accepted-mutation-merchant-auto-close.md`).~~ Pending next items-lane slice.
