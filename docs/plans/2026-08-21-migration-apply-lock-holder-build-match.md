...
3. ~~Add advisory `lock_age_seconds` / `lock_age_check` from `lock.created_at` vs the inspecting host wall clock.~~ Done: see [migration apply lock age](2026-08-21-migration-apply-lock-age.md).
