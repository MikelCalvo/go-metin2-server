...
4. Persistence/content migration follow-up for portable `combat_profiles[]` remains owned by [PvE vertical authoring 0012 export combat-profile gap](2026-08-22-pve-vertical-authoring-0012-export-combat-profile-gap.md).
