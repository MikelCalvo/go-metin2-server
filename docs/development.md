...
`cmd/metin2-migrate` is the first shipped migration CLI. Its catalog, status, empty-ledger-snapshot, ledger-snapshot, plan, and plan-artifact commands are preflight surfaces:
