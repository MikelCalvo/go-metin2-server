...
Dedicated coverage now freezes the item-shaped and gold-shaped reward halves of stale owner point-state registration, stale collector-death, stale collector-identity, stale collector-point, stale collector-location, stale owner-identity owner-delivery, and stale owner-location owner-delivery cases because both reward families share the same ground-entry pickup/removal seam.
