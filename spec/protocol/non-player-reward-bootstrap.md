...
Dedicated shared-world coverage freezes the stale-far-then-near case for both item-shaped drops and gold-shaped ground rewards: the stale snapshot cannot regain visibility, resolve pickup, or remove the ground entry, and the reward remains registered for a fresh current pickup attempt.
