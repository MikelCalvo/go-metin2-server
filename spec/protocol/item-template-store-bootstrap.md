...
- template-backed merchant sell-back rejects live carried stacks whose current count already exceeds the resolved template-authored `max_count` before credit calculation, item refreshes, quickslot cleanup, gold mutation, or persisted-state mutation
