...
4. The picked ground item snapshot itself must validate as a well-formed unequipped carried item before any compatible-stack merge or fresh-slot placement is attempted. Malformed ground snapshots, including stale snapshots that still carry an authored equipment slot while not marked equipped, fail closed before recipient inventory mutation, pickup notice, persistence, or temporary ground-handle removal.
