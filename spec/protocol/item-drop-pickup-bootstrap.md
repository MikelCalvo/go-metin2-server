...
6. This first gold-pickup slice is self/ordinary pickup only. Party-shaped gold pickup notices, ownership timers, public ownership release, richer gold-marker display/count semantics, and durable shared-world ground currency entities remain deferred.
