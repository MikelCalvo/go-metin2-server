...
8. If the recipient inventory already has duplicate carried-slot occupancy before pickup resolution, pickup fails closed before merge, placement, persistence, pickup notice, or temporary ground-handle removal. This prevents ambiguous merge-slot selection from mutating live state when the bootstrap runtime observes a malformed carried inventory snapshot.
