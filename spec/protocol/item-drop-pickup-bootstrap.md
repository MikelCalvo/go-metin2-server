...
18. Replayed, unknown, invisible, or zero-HP/dead-collector pickups fail closed with no frames; no-free-slot pickups use the inventory-full info chat path above.
