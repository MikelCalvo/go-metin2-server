...
- it does not yet delete item quickslots when safebox, item timeout, destruction, movement to non-carried storage, or other item-removal paths outside the owned mutual-accept exchange finalize and refine-confirm material-removal seams clear an item cell.
...
- automatic item quickslot deletion after safebox, item timeout, destruction, movement to non-carried storage, or other item-removal paths outside the owned mutual-accept exchange finalize and refine-confirm material-removal seams
