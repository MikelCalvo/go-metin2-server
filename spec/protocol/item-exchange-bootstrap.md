...
- richer trade target eligibility beyond the current visible-player check plus owned exchange-distance gate (`ApproxDistance < 1000`) and the requester-side open-merchant PREVENT_TRADE_WINDOW start reject
- partner-side open merchant / safebox / player-shop / cube busy-window rejection text
