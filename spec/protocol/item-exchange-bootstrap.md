...
- richer trade target eligibility beyond the current visible-player check plus owned exchange-distance gate (`ApproxDistance < 1000`), the requester-side open-merchant PREVENT_TRADE_WINDOW start reject, and the partner-side open-merchant busy-window rejection text
- partner-side open safebox / player-shop / cube busy-window rejection text
