...
- `internal/minimal` freezes runtime persistence and self-frame behavior for slash-command full-stack movement and direct `CG::ITEM_MOVE` full-stack moves, direct incompatible full-stack swaps, locked-destination rejection, counted incompatible-destination rejection, counted partial splits, compatible occupied-destination partial merges, and exact counted full-stack compatible merges.
