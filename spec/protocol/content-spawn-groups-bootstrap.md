...
- once that retaliation floor has already reached `0`, later owner-side carried gold-drop attempts also fail closed before ground-drop registration, queued visibility frames, or gold persistence can run
