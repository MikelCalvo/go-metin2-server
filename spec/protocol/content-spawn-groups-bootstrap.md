...
- `regen_spawns[]`
  ...
  - runtime import/export and live respawn still see only independent one-actor `spawn_groups[]` descriptors; this shape does not add a pack object, synchronized respawn, shared HP, random rectangle placement, direction, or legacy regen timers
