...
- `item-drop-pickup-bootstrap.md` — first frozen ground-item drop/pickup packet codecs and `GAME` dispatch seams, with shipped runtime behavior still fail-closed before ground-item state is owned
