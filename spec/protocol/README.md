...
- `combat-normal-attack-bootstrap.md` — first owned `ATTACK` wire contract, selected-dummy normal-attack gate, and clear-target companion on top of the visible `training_dummy` target slice
