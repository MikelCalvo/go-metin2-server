...
- `player-restart-request-bootstrap.md` — restart-ingress follow-up note: the owned recovery path still uses `/restart_here` and `/restart_town` through chat slash commands, and any separate dedicated restart packet remains unproven/capture-gated
