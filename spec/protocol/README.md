...
- `combat-damage-info-bootstrap.md` — first owned server `DAMAGE_INFO` codec contract for the fixed-width hit-effect carrier before runtime emission policy broadens
