...
- `non-player-reward-bootstrap.md` — first non-player death reward seam, default rewardless descriptors, and the current gold-only selected-player persistence + point-change edge
