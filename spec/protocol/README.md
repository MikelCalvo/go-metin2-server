...
- `quickslot-bootstrap.md` — first owned server-originated quickslot refresh packet codecs (`QUICKSLOT_ADD`, `QUICKSLOT_DEL`, `QUICKSLOT_SWAP`) before runtime quickslot synchronization
