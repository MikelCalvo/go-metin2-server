...
Later slices may extend that authored payload shape beyond these currently owned service-style definitions without changing the `INTERACT` request packet itself.
