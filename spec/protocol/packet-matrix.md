...
| `QUICKSLOT_SWAP` | server -> client | `0x051B` | game/bootstrap | documented | first owned server quickslot swap codec; payload is `pos uint8` + `pos_to uint8`; client-originated quickslot edit handling remains pending |
