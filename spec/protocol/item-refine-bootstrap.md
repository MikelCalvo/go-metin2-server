...
- richer inventory/equipment refresh ordering or peer notifications for accepted refine results beyond the self-only material / material-removal quickslot / result / gold burst above
...
- Lower-probability failure/destroy outcomes (including `CHAT_TYPE_COMMAND` `RefineFailed <type>`), catalysts, and broader refine-window choreography remain deferred.
