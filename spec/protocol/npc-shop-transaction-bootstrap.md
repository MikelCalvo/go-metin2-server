...
- already-open host second `CG::MYSHOP` currently rejects with the owned busy INFO string; **next frozen:** clear/close with the owned empty-sign companion instead (`docs/plans/2026-08-27-myshop-open-already-open-second-open-empty-sign-close.md`)
