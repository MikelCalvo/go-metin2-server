...
- **next frozen (not yet live):** when an unlisted carried silk bag (`vnum = 71049`) is present, accepted open skips ordinary `50200` consume and emits bag-less `SHOP_SIGN` without inventing `MYSHOP_PRICELIST` DB packets (`docs/plans/2026-08-27-myshop-silk-bag-71049-consume-skip.md`)
