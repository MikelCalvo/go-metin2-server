...
- guest browse open/leave/buy are owned separately; partner player-shop exchange busy rejects are owned separately; exchange open-cube busy rejects are owned separately; MYSHOP/safebox/refine open/confirm cube rejects are owned; cube `r_info`/`r_list` is contract-frozen (`docs/plans/2026-08-25-cube-r-info-result-list-contract-freeze.md`); `m_info` / add / delete / make stay deferred; empty-sign close companion is owned separately below
...
- guest browse open/leave/buy are owned separately below; partner player-shop exchange busy rejects are owned separately; exchange open-cube busy rejects are owned separately; MYSHOP/safebox/refine open/confirm cube rejects are owned; cube `r_info`/`r_list` is contract-frozen (`docs/plans/2026-08-25-cube-r-info-result-list-contract-freeze.md`); `m_info` / add / delete / make stay deferred; view-entry rematerialization of a remembered live sign is owned separately below
...
- guest browse open/leave/buy are owned separately; exchange open-cube busy rejects are owned separately; MYSHOP/safebox/refine open/confirm cube rejects are owned; cube `r_info`/`r_list` is contract-frozen (`docs/plans/2026-08-25-cube-r-info-result-list-contract-freeze.md`); `m_info` / add / delete / make stay deferred
