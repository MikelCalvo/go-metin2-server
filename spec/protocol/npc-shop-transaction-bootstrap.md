...
- empty sign / zero count / duplicate or invalid stock / `anti_give|anti_myshop` / open exchange|merchant|safebox|refine|cube stay fail-closed with no second live `SHOP_SIGN`
