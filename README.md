...
- authored item-template metadata for selected display/guard behavior, including template-backed refine-dialog preview metadata and content-bundle summary projection of refine guard metadata (`refineable` / `refine_reject_message`) before import,
