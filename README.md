...
- pickup into inventory with stack-merge behavior, template-authored pickup reach overrides for dropped item handles and bootstrap gold markers, valid authored equipment-template pickup as carried items rather than auto-equip, and guarded template-authored pickup-rejection info text for transfer/selected-character restriction failures,
