...
- [~] First combat slice: target selection for a visible `training_dummy`
...
| M4 — Combat vertical slice | [~] | Target selection exists; attack, damage, death, and respawn still need a first end-to-end slice. |
