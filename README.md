...
- tests around watcher/owner respawn, retarget, cleanup, reward, leash-classification, return-step planning, authored-home respawn-return, and stale return-step cleanup cases.
