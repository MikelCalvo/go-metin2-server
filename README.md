...
- `info`, `talk`, `quest_flag`, `warp`, `shop_preview`, `open_safebox`, and `open_cube` interaction kinds (composed PvE `CubeMaster` now also inspects bootstrap `/cube r_info` / `cube m_info` without mutation),
