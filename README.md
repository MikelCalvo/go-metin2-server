...
- fail-closed item-template validation for malformed equipment metadata, missing or null template collections, embedded-NUL template names, and unguarded authored pickup rejection text, including snapshots that combine stackable item semantics with an authored `equip_slot`,
