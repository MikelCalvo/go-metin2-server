...
- codec-owned presentation families for fly effects, PvP/duel, stun, change-speed, and target markers, plus a first presentation-only `CHARACTER_POSITION(position=0|4)` self/peer stance echo,
