...
- self-only `DAMAGE_INFO` hit-effect emission for standalone bootstrap `training_dummy` non-lethal hits, while broader emission policy remains narrow,
