...
func TestCanonicalizePveVerticalAuthoringExampleExpandsQuestLoop(t *testing.T) {
	...
	wantTemplates := []itemcatalog.Template{
		{Vnum: 11200, Name: "Wooden Sword", Stackable: false, MaxCount: 1, ShopSellPrice: 100, EquipSlot: "weapon", EquipEffect: &itemcatalog.PointEffect{PointType: 1, PointIndex: 1, PointDelta: 10}},
	...
	wantShopCatalog := ShopCatalogSummary{
		...
		Entries: []ShopCatalogEntrySummary{
			...
			{Slot: 1, ItemVnum: 11200, ItemName: "Wooden Sword", Count: 1, Price: 500, Stackable: false, MaxCount: 1, ShopSellPrice: 100, EquipSlot: "weapon", EquipEffect: &itemcatalog.PointEffect{PointType: 1, PointIndex: 1, PointDelta: 10}},
